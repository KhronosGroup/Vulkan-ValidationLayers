...
layer_source_files = [common_codegen.repo_relative(path) for path in [
    'layers/core_checks/android_cc_validation.cpp',
    'layers/core_checks/buffer_cc_validation.cpp',
    'layers/state_tracker/cmd_buffer_state.cpp', # some Video VUIDs are in here
    'layers/core_checks/cmd_buffer_dynamic_cc_validation.cpp',
    'layers/core_checks/cmd_buffer_cc_validation.cpp',
    'layers/core_checks/copy_blit_resolve_cc_validation.cpp',
    'layers/state_tracker/descriptor_sets.cpp',
    'layers/core_checks/descriptor_cc_validation.cpp',
    'layers/core_checks/device_cc_validation.cpp',
    'layers/core_checks/device_memory_cc_validation.cpp',
    'layers/core_checks/drawdispatch_cc_validation.cpp',
    'layers/core_checks/external_object_cc_validation.cpp',
    'layers/gpu_validation/gpu_vuids.h',
    'layers/stateless/buffer_sl_validation.cpp',
    'layers/stateless/cmd_buffer_dynamic_sl_validation.cpp',
    'layers/stateless/cmd_buffer_sl_validation.cpp',
    'layers/stateless/descriptor_sl_validation.cpp',
    'layers/stateless/device_memory_sl_validation.cpp',
    'layers/stateless/external_object_sl_validation.cpp',
    'layers/stateless/framebuffer_sl_validation.cpp',
    'layers/stateless/image_sl_validation.cpp',
    'layers/stateless/instance_device_sl_validation.cpp',
    'layers/stateless/pipeline_sl_validation.cpp',
    'layers/stateless/ray_tracing_sl_validation.cpp',
    'layers/stateless/render_pass_sl_validation.cpp',
    'layers/stateless/synchronization_sl_validation.cpp',
    'layers/stateless/wsi_sl_validation.cpp',
    'layers/core_checks/image_cc_validation.cpp',
    'layers/core_checks/image_layout_cc_validation.cpp',
    'layers/core_checks/pipeline_cc_validation.cpp',
    'layers/object_tracker/object_tracker_utils.cpp',
    'layers/core_checks/query_cc_validation.cpp',
    'layers/core_checks/queue_cc_validation.cpp',
    'layers/core_checks/ray_tracing_cc_validation.cpp',
    'layers/core_checks/render_pass_cc_validation.cpp',
    'layers/state_tracker/shader_module.cpp',
    'layers/core_checks/shader_cc_validation.cpp',
    'layers/core_checks/synchronization_cc_validation.cpp',
    'layers/stateless/stateless_validation.h',
    'layers/sync/sync_validation.cpp',
    'layers/sync/sync_vuid_maps.cpp',
    'layers/core_checks/video_cc_validation.cpp',
    'layers/core_checks/wsi_cc_validation.cpp',
    'layers/core_checks/ycbcr_cc_validation.cpp',
