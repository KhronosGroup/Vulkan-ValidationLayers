...
def main(argv):
    ...
    verify_exclude = [
        ...
        'cmd_validation_count_buffer_vert.h',
        'cmd_validation_count_buffer_vert.cpp',
        'cmd_validation_first_instance_vert.h',
        'cmd_validation_first_instance_vert.cpp',
        'cmd_validation_draw_indexed_vert.h',
        'cmd_validation_draw_indexed_vert.cpp',
        'cmd_validation_draw_indexed_indirect_index_buffer_vert.h',
        'cmd_validation_draw_indexed_indirect_index_buffer_vert.cpp',
        'cmd_validation_draw_indexed_indirect_vertex_buffer_vert.h',
        'cmd_validation_draw_indexed_indirect_vertex_buffer_vert.cpp',
        'cmd_validation_draw_mesh_indirect_vert.h',
        'cmd_validation_draw_mesh_indirect_vert.cpp',
