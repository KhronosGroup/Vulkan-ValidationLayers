...
def main(argv):
    ...
    verify_exclude = [
        ...
        'validation_cmd_trace_rays_comp.h',
        'validation_cmd_trace_rays_comp.cpp',
        'instrumentation_buffer_device_address_comp.h',
        'instrumentation_buffer_device_address_comp.cpp',
        'instrumentation_descriptor_indexing_oob_comp.h',
        'instrumentation_descriptor_indexing_oob_comp.cpp',
