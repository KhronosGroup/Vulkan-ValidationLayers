...
def main(argv):
    ...
    verify_exclude = [
        ...
        'cmd_validation_indirect_draw_vert.h',
        'cmd_validation_indirect_draw_vert.cpp',
        'cmd_validation_indexed_draw_vert.h',
        'cmd_validation_indexed_draw_vert.cpp',
        'cmd_validation_mesh_draw_vert.h',
        'cmd_validation_mesh_draw_vert.cpp',
