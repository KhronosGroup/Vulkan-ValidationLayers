...
"""
    ...
    def endFile(self):
        ...
        if not self.header:
            ...
            write('#include "vulkan/layer_chassis_dispatch.h"', file=self.outFile)
            write('#include "vulkan/vk_layer_utils.h"', file=self.outFile)
            write('#include "vulkan/vk_safe_struct.h"', file=self.outFile)
            self.newline()
