...
def makeGenOpts(args):
    ...
    # Helper file generator options for corechecks_instrumentation.h
    genOpts['corechecks_instrumentation.h'] = [
          HelperFileOutputGenerator,
          HelperFileOutputGeneratorOptions(
            conventions       = conventions,
            filename          = 'corechecks_instrumentation.h',
            directory         = directory,
            genpath           = None,
            apiname           = 'vulkan',
            profile           = None,
            ...
            alignFuncParam    = 48,
            expandEnumerants  = False,
            helper_file_type  = 'cc_instrumentation_header')
        ]

    # Helper file generator options for corechecks_instrumentation.cpp
    genOpts['corechecks_instrumentation.cpp'] = [
          HelperFileOutputGenerator,
          HelperFileOutputGeneratorOptions(
            conventions       = conventions,
            filename          = 'corechecks_instrumentation.cpp',
            directory         = directory,
            genpath           = None,
            apiname           = 'vulkan',
            profile           = None,
            ...
            alignFuncParam    = 48,
            expandEnumerants  = False,
            helper_file_type  = 'cc_instrumentation_source')
        ]
