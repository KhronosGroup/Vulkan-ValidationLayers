...
def makeGenOpts(args):
    ...
    # uber_layer related generation structs
    # Options for uber layer header
    genOpts['uber_layer.h'] = [
          UberLayerOutputGenerator,
          UberLayerGeneratorOptions(
            filename          = 'uber_layer.h',
            directory         = directory,
            apiname           = 'vulkan',
            profile           = None,
            versions          = featuresPat,
            ...
            apientryp         = 'VKAPI_PTR *',
            alignFuncParam    = 48,
            helper_file_type  = 'uber_layer_header',
            expandEnumerants = False)
        ]

    # Options for uber layer source file
    genOpts['uber_layer.cpp'] = [
          UberLayerOutputGenerator,
          UberLayerGeneratorOptions(
            filename          = 'uber_layer.cpp',
            directory         = directory,
            apiname           = 'vulkan',
            profile           = None,
            versions          = featuresPat,
            ...
            apientryp         = 'VKAPI_PTR *',
            alignFuncParam    = 48,
            helper_file_type  = 'uber_layer_source',
            expandEnumerants = False)
        ]
