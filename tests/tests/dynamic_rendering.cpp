...
class DynamicRendering : public VkLayerTest {
  public:
    void InitBasicDynamicRendering();
};
class NegativeDynamicRendering : public DynamicRendering {};
class PositiveDynamicRendering : public DynamicRendering {};

void DynamicRendering::InitBasicDynamicRendering() {
...
TEST_F(NegativeDynamicRendering, MistmatchingAttachmentFormats3) {
    ...
    auto dynamic_rendering_unused_attachments_features =
        LvlInitStruct<VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT>();
    auto dynamic_rendering_features =
        LvlInitStruct<VkPhysicalDeviceDynamicRenderingFeaturesKHR>(&dynamic_rendering_unused_attachments_features);
    GetPhysicalDeviceFeatures2(dynamic_rendering_features);
    if (!dynamic_rendering_features.dynamicRendering) {
        GTEST_SKIP() << "Test requires (unsupported) dynamicRendering , skipping.";
    }
