...
TEST_F(PositiveLayerUtils, IsOnlyOneValidPlaneAspect) {
    ...
    ASSERT_FALSE(
        IsOnlyOneValidPlaneAspect(two_plane_format, VK_IMAGE_ASPECT_PLANE_0_BIT | VK_IMAGE_ASPECT_PLANE_1_BIT));
    ASSERT_FALSE(
        IsOnlyOneValidPlaneAspect(two_plane_format, VK_IMAGE_ASPECT_PLANE_0_BIT | VK_IMAGE_ASPECT_PLANE_2_BIT));
...
TEST_F(PositiveLayerUtils, IsMultiplePlaneAspect) {
    ...
    ASSERT_TRUE(
        IsMultiplePlaneAspect(VK_IMAGE_ASPECT_PLANE_0_BIT | VK_IMAGE_ASPECT_PLANE_1_BIT | VK_IMAGE_ASPECT_PLANE_2_BIT));
...
TEST_F(PositiveLayerUtils, IsImageLayoutDepthOnly) {
    ...
    constexpr std::array all_layouts_but_depth_only{ VK_IMAGE_LAYOUT_UNDEFINED,
...
TEST_F(PositiveLayerUtils, IsImageLayoutStencilOnly) {
    ...
    constexpr std::array all_layouts_but_stencil_only{ VK_IMAGE_LAYOUT_UNDEFINED,
                                                       VK_IMAGE_LAYOUT_GENERAL,
                                                       VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
                                                       VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL,
                                                       VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL,
