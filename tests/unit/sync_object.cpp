...
TEST_F(NegativeSyncObject, BarrierAccessSync2MemoryDecompression) {
    ...
    mem_barrier.srcStageMask = VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT;
    m_errorMonitor->SetDesiredError("VUID-VkMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT");
    m_command_buffer.BarrierKHR(mem_barrier);
    m_errorMonitor->VerifyFound();
    ...
    mem_barrier.srcStageMask = VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT;
    m_errorMonitor->SetDesiredError("VUID-VkMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT");
    m_command_buffer.BarrierKHR(mem_barrier);
    m_errorMonitor->VerifyFound();
    ...
    mem_barrier.dstStageMask = VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT;
    m_errorMonitor->SetDesiredError("VUID-VkMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT");
    m_command_buffer.BarrierKHR(mem_barrier);
    m_errorMonitor->VerifyFound();
    ...
    mem_barrier.dstStageMask = VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT;
    m_errorMonitor->SetDesiredError("VUID-VkMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT");
    m_command_buffer.BarrierKHR(mem_barrier);
    m_errorMonitor->VerifyFound();
