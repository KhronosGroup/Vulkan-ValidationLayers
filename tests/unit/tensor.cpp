...
TEST_F(NegativeTensor, RollingInvalidTiling) {
    ...
    /* This must be a complement of `valid_rolling_tilings` in tensor_positive.cpp */
...
TEST_F(NegativeTensor, RollingInvalidDimensions) {
    ...
    VkTensorCreateInfoARM info = DefaultCreateInfo(&desc);
    VkTensorRollingBackingCreateInfoARM rolling_info = InitTensorRollingInfo({1, 2, 2, 4});
    info.pNext = &rolling_info;
...
TEST_F(NegativeTensor, RollingWrapsGreatherThanDimensions) {
    ...
    VkTensorCreateInfoARM info = DefaultCreateInfo(&desc);
    VkTensorRollingBackingCreateInfoARM rolling_info = InitTensorRollingInfo({1, 8, 8, 8}); /* w[1] > dim[1] */
    info.pNext = &rolling_info;
...
TEST_F(NegativeTensor, RollingWrapsNEqDimensionAndGreatherThan2exp16) {
    ...
    VkTensorCreateInfoARM info = DefaultCreateInfo(&desc);
    VkTensorRollingBackingCreateInfoARM rolling_info = InitTensorRollingInfo({1, 4, 70000, 64}); /* 70000 > 2^16 */
    info.pNext = &rolling_info;
...
TEST_F(NegativeTensor, RollingWrapsNEqDimensionAndNotPow2) {
    ...
    VkTensorCreateInfoARM info = DefaultCreateInfo(&desc);
    VkTensorRollingBackingCreateInfoARM rolling_info = InitTensorRollingInfo({1, 3, 7, 64}); /* 3, 7 not power of 2 */
    info.pNext = &rolling_info;
...
TEST_F(NegativeTensor, RollingWrapsNotMultipleOfBrickOuterSize) {
    ...
    VkTensorRollingBackingCreateInfoARM rolling_info =
        InitTensorRollingInfo({1, 2, 6, 32}); /* 6 > brickOuterSize (4) and not a multiple of it */
    info.pNext = &rolling_info;
...
TEST_F(NegativeTensor, RollingWrapsNotMultipleOf64DivBrickOuterSizeDivElementSize) {
    ...
    VkTensorCreateInfoARM info = DefaultCreateInfo(&desc);
    VkTensorRollingBackingCreateInfoARM rolling_info =
        InitTensorRollingInfo({1, 2, 34, 32}); /* 34 NOT a multiple of 16 = 64 / brickOuterSize (4) / elementSize (1) */
    info.pNext = &rolling_info;
