...
TEST_F(NegativeDataGraph, CreateDataGraphPipelinesDeferredOperationNotNull) {
    ...
    vkt::dg::CreateDataGraphPipelineHelper pipeline_helper(*this);
...
TEST_F(NegativeDataGraph, CreateDataGraphPipelinesInvalidFlags) {
    ...
    auto set_info = [](vkt::dg::CreateDataGraphPipelineHelper &pipeline) {
...
TEST_F(NegativeDataGraph, CreateDataGraphPipelinesPushConstantCountNotZero) {
    ...
    auto set_info = [&](vkt::dg::CreateDataGraphPipelineHelper &pipeline) { pipeline.CreatePipelineLayout(pcr); };
...
TEST_F(NegativeDataGraph, CreateDataGraphPipelinesTypeMismatch) {
    ...
    vkt::dg::CreateDataGraphPipelineHelper::OneshotTest(*this, set_info, 0, errors);
}
...
TEST_F(NegativeDataGraph, PipelineResourceInfoInvalidArrayElement) {
    ...
    InitBasicDataGraph();
    RETURN_IF_SKIP(Init());
    auto set_info = [&](vkt::dg::CreateDataGraphPipelineHelper &pipeline) { pipeline.resources_.back().arrayElement = 1; };
    vkt::dg::CreateDataGraphPipelineHelper::OneshotTest(*this, set_info, 0,
...
TEST_F(NegativeDataGraph, ShaderSpirvUsesOpSpecFeatureNotEnabled) {
    ...
    vkt::dg::CreateDataGraphPipelineHelper pipeline(*this, false /*protected_tensors*/, true /*is_data_graph*/,
                                                    "%dummy_spec_constant = OpSpecConstant %uint 3");
