...
TEST_F(NegativeGpuAVImageLayout, ImageArrayDynamicIndexing) {
    ...
    vkt::Image image(*m_device, 16, 16, VK_FORMAT_B8G8R8A8_UNORM, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT);
...
TEST_F(NegativeGpuAVImageLayout, MultipleCommandBuffersSameDescriptorSet) {
    ...
    cb_0.Begin();
    vk::CmdBindPipeline(cb_0, VK_PIPELINE_BIND_POINT_COMPUTE, pipe);
    ...
    cb_1.Begin();
    vk::CmdBindPipeline(cb_1, VK_PIPELINE_BIND_POINT_COMPUTE, pipe);
    ...
    bad_image.TransitionLayout(VK_IMAGE_LAYOUT_GENERAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
