...
TEST_F(PositiveYcbcr, MultiplaneImageCopyBufferToImage) {
    ...
    image.InitialImageMemoryBarrier(m_command_buffer, 0, VK_ACCESS_TRANSFER_WRITE_BIT, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
...
TEST_F(PositiveYcbcr, ImageLayout) {
    ...
    m_command_buffer.Begin();
    image.InitialImageMemoryBarrier(m_command_buffer, 0, 0, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
