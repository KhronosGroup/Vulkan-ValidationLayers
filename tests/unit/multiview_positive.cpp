...
TEST_F(PositiveMultiview, DynamicRenderingAttachmentLayerCount) {
    TEST_DESCRIPTION("https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/12209");
    SetTargetApiVersion(VK_API_VERSION_1_2);
    ...
    // Resolve attachment, 2 layers, single-sampled
    auto resolve_ci = vkt::Image::ImageCreateInfo2D(32, 32, 1, 2, color_format, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT);
