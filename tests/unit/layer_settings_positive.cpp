...
TEST_F(PositiveLayerSettings, AllSettings) {
    ...
    std::vector<VkLayerSettingEXT> settings = { {
        ...
        { OBJECT_LAYER_NAME,
          "syncval_message_extra_properties_pretty_print",
    ...
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, (uint32_t)settings.size(), settings.data()
    };
...
TEST_F(PositiveLayerSettings, ReportFlags) {
    ...
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "report_flags", VK_LAYER_SETTING_TYPE_STRING_EXT, 3, report_flags
    };
    VkLayerSettingsCreateInfoEXT create_info = {
