...
TEST_F(NegativeCopyBufferImage, MemoryIndirectFeature) {
    ...
    vkt::Buffer indirect_buffer(*m_device, sizeof(VkCopyMemoryIndirectCommandKHR), 0, vkt::device_address);

    VkStridedDeviceAddressRangeKHR copy_address_range = {};
    copy_address_range.address = indirect_buffer.Address();
    copy_address_range.stride = sizeof(VkCopyMemoryIndirectCommandKHR);
    copy_address_range.size = sizeof(VkCopyMemoryIndirectCommandKHR);
...
TEST_F(NegativeCopyBufferImage, MemoryIndirect) {
    ...
    copy_address_range.stride = sizeof(VkCopyMemoryIndirectCommandKHR) + 1;  // Not aligned
    indirect_info.copyAddressRange = copy_address_range;
    ...
    copy_address_range.stride = sizeof(VkCopyMemoryIndirectCommandKHR) - 4;  // Too small
    indirect_info.copyAddressRange = copy_address_range;
    m_errorMonitor->SetDesiredError("VUID-VkCopyMemoryIndirectInfoKHR-copyAddressRange-10943");
    vk::CmdCopyMemoryIndirectKHR(m_command_buffer, &indirect_info);
    m_errorMonitor->VerifyFound();

    copy_address_range.stride = sizeof(VkCopyMemoryIndirectCommandKHR);  // Fix stride
    copy_address_range.size = sizeof(VkCopyMemoryIndirectCommandKHR);    // Only enough for one command
...
TEST_F(NegativeCopyBufferImage, MemoryIndirectProtect) {
    ...
    address_range.size = sizeof(VkCopyMemoryIndirectCommandKHR);
...
TEST_F(NegativeCopyBufferImage, MemoryIndirectBufferOverflow) {
    ...
    copy_info.copyAddressRange.size = sizeof(VkCopyMemoryIndirectCommandKHR);
...
TEST_F(NegativeCopyBufferImage, MemoryToImageIndirectFeature) {
    ...
    VkStridedDeviceAddressRangeKHR copy_address_range = {};
    copy_address_range.address = indirect_buffer.Address();
    copy_address_range.stride = sizeof(VkCopyMemoryToImageIndirectCommandKHR);
    copy_address_range.size = sizeof(VkCopyMemoryToImageIndirectCommandKHR);
...
TEST_F(NegativeCopyBufferImage, MemoryToImageIndirect) {
    ...
    copy_address_range.address = indirect_buffer.Address();
    copy_address_range.stride = sizeof(VkCopyMemoryToImageIndirectCommandKHR);
    copy_address_range.size = sizeof(VkCopyMemoryToImageIndirectCommandKHR) * 2;
    ...
    copy_address_range.address = indirect_buffer.Address();                         // Fix address alignment
    copy_address_range.stride = sizeof(VkCopyMemoryToImageIndirectCommandKHR) + 1;  // Not aligned
    indirect_info.copyAddressRange = copy_address_range;
    m_errorMonitor->SetDesiredError("VUID-VkCopyMemoryToImageIndirectInfoKHR-copyAddressRange-10953");
    vk::CmdCopyMemoryToImageIndirectKHR(m_command_buffer, &indirect_info);
    m_errorMonitor->VerifyFound();

    copy_address_range.stride = sizeof(VkCopyMemoryToImageIndirectCommandKHR) - 4;  // Too small
    indirect_info.copyAddressRange = copy_address_range;
    m_errorMonitor->SetDesiredError("VUID-VkCopyMemoryToImageIndirectInfoKHR-copyAddressRange-10953");
    vk::CmdCopyMemoryToImageIndirectKHR(m_command_buffer, &indirect_info);
    m_errorMonitor->VerifyFound();

    copy_address_range.stride = sizeof(VkCopyMemoryToImageIndirectCommandKHR);  // Fix stride
    copy_address_range.size = sizeof(VkCopyMemoryToImageIndirectCommandKHR);    // Only enough for one command
