...
void GpuAVImageLayout::InitGpuAVImageLayout() {
    ...
    // https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/8869 are still showing false positives Need to
    // manually turn on settings while the default is "off"
    const VkBool32 value_true = true;
    const VkLayerSettingEXT layer_setting = {
        OBJECT_LAYER_NAME, "gpuav_image_layout", VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &value_true
    };
