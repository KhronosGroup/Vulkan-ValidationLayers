...
TEST_F(NegativeLayerSettings, CustomStypeStructString) {
    ...
    const VkLayerSettingEXT setting = { OBJECT_LAYER_NAME,
                                        "custom_stype_list",
                                        VK_LAYER_SETTING_TYPE_STRING_EXT,
                                        static_cast<uint32_t>(std::size(id)),
                                        &id };
...
TEST_F(NegativeLayerSettings, CustomStypeStructStringArray) {
    ...
    const VkLayerSettingEXT setting = { OBJECT_LAYER_NAME,
                                        "custom_stype_list",
                                        VK_LAYER_SETTING_TYPE_STRING_EXT,
                                        static_cast<uint32_t>(std::size(ids)),
                                        &ids };
    VkLayerSettingsCreateInfoEXT layer_setting_create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, DuplicateMessageLimitDisable) {
    ...
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 2, settings
    };
...
TEST_F(NegativeLayerSettings, VuidIdFilterString) {
    ...
    VkRenderPassInputAttachmentAspectCreateInfo rpiaaci = {
        VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO, nullptr, 1, &iaar
    };
    VkRenderPassCreateInfo rpci = {
        VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO, &rpiaaci, 0, 1, &attach, 1, &subpass, 0, nullptr
    };
...
TEST_F(NegativeLayerSettings, DebugAction) {
    ...
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "debug_action", VK_LAYER_SETTING_TYPE_STRING_EXT, 1, &action
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, DebugAction2) {
    ...
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "debug_action", VK_LAYER_SETTING_TYPE_STRING_EXT, 1, actions
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, DebugAction3) {
    ...
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "debug_action", VK_LAYER_SETTING_TYPE_STRING_EXT, 2, actions
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, ReportFlags) {
    ...
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "report_flags", VK_LAYER_SETTING_TYPE_STRING_EXT, 1, &report_flag
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, NotRealSetting) {
    int32_t enable = 1;
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "not_a_real_setting", VK_LAYER_SETTING_TYPE_INT32_EXT, 1, &enable
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
...
TEST_F(NegativeLayerSettings, WrongSettingType) {
    ...
    int32_t enable = 1;
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "enable_message_limit", VK_LAYER_SETTING_TYPE_UINT32_EXT, 1, &enable
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
    Monitor().ExpectSuccess(kErrorBit | kWarningBit);
    Monitor().SetDesiredWarning(
        " The setting enable_message_limit in VkLayerSettingsCreateInfoEXT was set to type "
        "VK_LAYER_SETTING_TYPE_UINT32_EXT but "
...
TEST_F(NegativeLayerSettings, WrongSettingType2) {
    ...
    int32_t enable = 1;
    const VkLayerSettingEXT setting = {
        OBJECT_LAYER_NAME, "thread_safety", VK_LAYER_SETTING_TYPE_UINT32_EXT, 1, &enable
    };
    VkLayerSettingsCreateInfoEXT create_info = {
        VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT, nullptr, 1, &setting
    };
    Monitor().ExpectSuccess(kErrorBit | kWarningBit);
    Monitor().SetDesiredWarning(" The setting thread_safety in VkLayerSettingsCreateInfoEXT was set to type "
                                "VK_LAYER_SETTING_TYPE_UINT32_EXT but requires "
...
TEST_F(NegativeLayerSettings, DuplicateSettings) {
    ...
    Monitor().ExpectSuccess(kErrorBit | kWarningBit);
    Monitor().SetDesiredWarning("The setting enable_message_limit in VkLayerSettingsCreateInfoEXT was listed twice and "
                                "only the first one listed will be "
                                "recognized");
    RETURN_IF_SKIP(InitFramework(&create_info));
    RETURN_IF_SKIP(InitState());
    Monitor().VerifyFound();
