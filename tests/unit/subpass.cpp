...
// Need clarification about VUID-vkCmdPipelineBarrier2-None-07893
TEST_F(NegativeSubpass, DISABLED_DependencyViewLocalSubpass) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME);
    ...
    memory_barrier_2.dstAccessMask = VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT;
    ...
    // m_errorMonitor->SetDesiredError("VUID-vkCmdPipelineBarrier2-None-07893");
