...
TEST_F(PositiveGpuAVDescriptorIndexing, SharedPipelineLayoutSubsetGrapahics) {
    TEST_DESCRIPTION("https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/8377");
    RETURN_IF_SKIP(InitGpuVUDescriptorIndexing());
    InitRenderTarget();
    ...
    VkShaderObj vs1(this, source_1, VK_SHADER_STAGE_VERTEX_BIT);
    VkShaderObj vs2(this, source_2, VK_SHADER_STAGE_VERTEX_BIT);

    CreatePipelineHelper pipe1(*this);
    pipe1.shader_stages_ = {vs1.GetStageCreateInfo(), pipe1.fs_->GetStageCreateInfo()};
    pipe1.gp_ci_.layout = pipeline_layout_1.handle();
    pipe1.CreateGraphicsPipeline();

    CreatePipelineHelper pipe2(*this);
    pipe2.shader_stages_ = {vs2.GetStageCreateInfo(), pipe2.fs_->GetStageCreateInfo()};
    pipe2.gp_ci_.layout = pipeline_layout_2.handle();
