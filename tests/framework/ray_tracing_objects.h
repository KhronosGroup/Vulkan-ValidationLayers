...
class GeometryKHR {
  public:
    ...
    GeometryKHR& SetSpheresVertexAddressNull();
    GeometryKHR& SetSpheresRadiusAddressNull();
    ...
    GeometryKHR& SetLSSpheresVertexAddressNull();
    GeometryKHR& SetLSSpheresRadiusAddressNull();
