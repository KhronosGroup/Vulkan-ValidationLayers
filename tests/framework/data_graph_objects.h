...
class CreateDataGraphPipelineHelper {
  public:
    ...
    VkDataGraphPipelineCreateInfoARM pipeline_create_info_ = {};
    vkt::ShaderModule shader_;
    VkDataGraphPipelineShaderModuleCreateInfoARM pipeline_shader_module_;
    ...
    explicit CreateDataGraphPipelineHelper(VkLayerTest &test, bool create_valid = false, bool protected_tensors = false, const char *inserted_line = "");
    virtual ~CreateDataGraphPipelineHelper();
    void Destroy();

    void CreateComputeShaderModule();
    void CreateGraphShaderModule(const char *inserted_line = "");
