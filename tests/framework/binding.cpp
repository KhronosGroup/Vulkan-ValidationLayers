...
void DataGraphPipelineSession::AllocSessionMem(std::vector<vkt::DeviceMemory> &device_mem, size_t scale_factor, int32_t size_modifier) {
    ...
    for (size_t i = 0; i < device_mem.size(); i++) {
        ...
        auto flags = (create_info_.flags & VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_PROTECTED_BIT_ARM) ? VK_MEMORY_PROPERTY_PROTECTED_BIT : 0;
