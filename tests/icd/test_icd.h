...
static u64 global_unique_handle = 1;
static const u32 SUPPORTED_LOADER_ICD_INTERFACE_VERSION = 5;
static u32 loader_interface_version = 0;
...
static constexpr u32 icd_physical_device_count = 1;
...
static std::unordered_map<VkDevice, std::unordered_map<u32, std::unordered_map<u32, VkQueue>>> queue_map;
...
static constexpr u32 icd_swapchain_image_count = 1;
