...
static VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceCooperativeMatrixPropertiesKHR(
    ...
    static constexpr std::array<VkCooperativeMatrixPropertiesKHR, 23> cooperative_matrix_properties = {{
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 16, 16, 16, VK_COMPONENT_TYPE_UINT32_KHR,
         VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 16, 16, 16, VK_COMPONENT_TYPE_UINT32_KHR,
         VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_FALSE, VK_SCOPE_DEVICE_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 16, 16, 16, VK_COMPONENT_TYPE_BFLOAT16_KHR,
         VK_COMPONENT_TYPE_BFLOAT16_KHR, VK_COMPONENT_TYPE_BFLOAT16_KHR, VK_COMPONENT_TYPE_BFLOAT16_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 16, 16, 16, VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT,
         VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT, VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT, VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 8, 8, 16, VK_COMPONENT_TYPE_FLOAT16_KHR,
         VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 16, 16, 16, VK_COMPONENT_TYPE_FLOAT16_KHR,
         VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 64, 8, VK_COMPONENT_TYPE_FLOAT32_KHR,
         VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 64, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 64, 32, VK_COMPONENT_TYPE_SINT8_KHR,
         VK_COMPONENT_TYPE_SINT8_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 64, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_FALSE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 64, 32, VK_COMPONENT_TYPE_SINT8_KHR,
         VK_COMPONENT_TYPE_SINT8_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 16, VK_COMPONENT_TYPE_FLOAT16_KHR,
         VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 8, VK_COMPONENT_TYPE_FLOAT32_KHR,
         VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 32, VK_COMPONENT_TYPE_SINT8_KHR,
         VK_COMPONENT_TYPE_SINT8_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_FALSE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 32, 32, VK_COMPONENT_TYPE_SINT8_KHR,
         VK_COMPONENT_TYPE_SINT8_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 16, VK_COMPONENT_TYPE_FLOAT16_KHR,
         VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_COMPONENT_TYPE_FLOAT16_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 8, VK_COMPONENT_TYPE_FLOAT32_KHR,
         VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_COMPONENT_TYPE_FLOAT32_KHR, VK_FALSE,
         VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 32, VK_COMPONENT_TYPE_SINT8_KHR,
         VK_COMPONENT_TYPE_SINT8_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_COMPONENT_TYPE_SINT32_KHR, VK_TRUE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 32, VK_COMPONENT_TYPE_UINT8_KHR,
         VK_COMPONENT_TYPE_UINT8_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_COMPONENT_TYPE_UINT32_KHR, VK_FALSE, VK_SCOPE_SUBGROUP_KHR},
        {VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR, nullptr, 64, 16, 32, VK_COMPONENT_TYPE_SINT8_KHR,
    ...
    const uint32_t total_count = static_cast<uint32_t>(cooperative_matrix_properties.size());
    if (!pProperties) {
        *pPropertyCount = total_count;
    } else {
        const uint32_t write_count = std::min(*pPropertyCount, total_count);
        for (uint32_t index = 0; index < write_count; ++index) {
            const VkCooperativeMatrixPropertiesKHR& property = cooperative_matrix_properties[index];
            pProperties[index].MSize = property.MSize;
            pProperties[index].NSize = property.NSize;
            pProperties[index].KSize = property.KSize;
            pProperties[index].AType = property.AType;
            pProperties[index].BType = property.BType;
            pProperties[index].CType = property.CType;
            pProperties[index].ResultType = property.ResultType;
            pProperties[index].saturatingAccumulation = property.saturatingAccumulation;
            pProperties[index].scope = property.scope;
        }
        *pPropertyCount = write_count;
    }
    return *pPropertyCount < total_count ? VK_INCOMPLETE : VK_SUCCESS;
}
