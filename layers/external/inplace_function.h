...
struct vtable
{
    ...
    explicit constexpr vtable() noexcept :
        ...
        relocate_ptr{ [](storage_ptr_t, storage_ptr_t) -> void {} }, destructor_ptr{ [](storage_ptr_t) -> void {} }
    {}
...
class inplace_function<R(Args...), Capacity, Alignment>
{
  ...
  public:
    ...
    inplace_function& operator=(inplace_function other) noexcept
    {
        ...
        vtable_ptr_ =
            std::exchange(other.vtable_ptr_, std::addressof(inplace_function_detail::empty_vtable<R, Args...>));
        vtable_ptr_->relocate_ptr(std::addressof(storage_), std::addressof(other.storage_));
        return *this;
    }
