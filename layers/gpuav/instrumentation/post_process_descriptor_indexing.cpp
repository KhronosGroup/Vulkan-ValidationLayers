...
void RegisterPostProcessingValidation(Validator& gpuav, CommandBufferSubState& cb) {
    ...
    cb.on_post_cb_submission_functions.emplace_back(
        [bound_desc_sets_to_pp_buffer_map](Validator& gpuav, CommandBufferSubState& cb, VkCommandBuffer per_post_submission_cb) {
            VVL_ZoneScoped;
