...
class DescriptorSet : public vvl::DescriptorSetProxy {
  public:
    DescriptorSet(const vvl::DescriptorSet &set, Validator &state_data);
...
static inline DescriptorSet &SubState(vvl::DescriptorSet &set) {
    return static_cast<DescriptorSet &>(*set.SubState(LayerObjectTypeGpuAssisted));
}
