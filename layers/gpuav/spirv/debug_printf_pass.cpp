...
void DebugPrintfPass::CreateBufferWriteFunction(uint32_t argument_count, uint32_t function_id,
    ...
    // Store how many 32-bit words
    {
        ...
        store_block.CreateInstruction(spv::OpStore,
                                      {printf_buffer_access_chain_id, byte_written_id, 0x2 /*Memory operand: Aligned*/, 4});
    }
    ...
    // Store Shader Stage ID
    {
        ...
        store_block.CreateInstruction(spv::OpStore, {printf_buffer_access_chain_id, shader_id, 0x2 /*Memory operand: Aligned*/, 4});
    }
    ...
    for (uint32_t i = 0; i < argument_count; i++) {
        ...
        store_block.CreateInstruction(spv::OpStore,
                                      {printf_buffer_access_chain_id, function_param_ids[i], 0x2 /*Memory operand: Aligned*/, 4});
    }
