...
struct AccelerationStructureReferencePushData {
    ...
    PtrToBlasArray blas_array_start_addr;  // TLAS array to validate
    PtrToAccelerationStructureBuildRangeInfos ptr_to_accel_struct_build_range_infos;
    uint flattened_build_range_i;  // Allows to point to the build range corresponding to the TLAS array
};
