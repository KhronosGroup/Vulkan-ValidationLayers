...
// Returns false when instruction_position_offset does not name an instruction, which the caller can use
// to add why that might be (for shared memory data races, the application indexing shared memory OOB).
