...
static const std::array<SyncStageAccessInfoType, 107> variable = { {
    {
...
const std::map<VkPipelineStageFlags2, int>& syncStageOrder() {
    ...
    { VK_PIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NV, 29},
    { VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT, 30},
    { VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT, 31},
    { VK_PIPELINE_STAGE_2_HOST_BIT, 32},
    { VK_PIPELINE_STAGE_2_PRESENT_ENGINE_BIT_SYNCVAL, 33},
    };
    return variable;
}
