...
const std::array<SyncStageAccessInfoType, 82> syncStageAccessInfoByStageAccessIndex { {
    {
...
const std::map<VkPipelineStageFlags2KHR, int> syncStageOrder {
    ...
    { VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI, 14},
    { VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR, 15},
    { VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR, 16},
    { VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR, 17},
    { VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR, 18},
    { VK_PIPELINE_STAGE_2_COPY_BIT_KHR, 19},
    { VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR, 20},
    { VK_PIPELINE_STAGE_2_BLIT_BIT_KHR, 21},
    { VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR, 22},
    { VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV, 23},
    { VK_PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT, 24},
    { VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR, 25},
    { VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR, 26},
