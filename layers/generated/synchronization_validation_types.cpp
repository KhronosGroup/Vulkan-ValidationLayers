...
const std::array<SyncStageAccessInfoType, 91> syncStageAccessInfoByStageAccessIndex { {
    {
...
const std::map<VkPipelineStageFlags2, int> syncStageOrder {
    ...
    { VK_PIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NV, 28},
    { VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI, 29},
    { VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT, 30},
    { VK_PIPELINE_STAGE_2_HOST_BIT, 31},
};
