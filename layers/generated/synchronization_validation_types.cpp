...
const std::array<SyncStageAccessInfoType, 96> syncStageAccessInfoByStageAccessIndex { {
    {
...
const std::map<VkPipelineStageFlags2, int> syncStageOrder {
    ...
    { VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT, 26},
    ...
    { VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI, 30},
