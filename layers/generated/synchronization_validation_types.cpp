...
const std::array<SyncStageAccessInfoType, 81> syncStageAccessInfoByStageAccessIndex { {
    {
...
const std::map<VkPipelineStageFlags2KHR, int> syncStageOrder {
    ...
    { VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR, 28},
    { VK_PIPELINE_STAGE_2_HOST_BIT_KHR, 29},
};
