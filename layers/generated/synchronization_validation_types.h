...
enum SyncStageAccessIndex {
    ...
    SYNC_VERTEX_SHADER_SHADER_BINDING_TABLE_READ = 6,
    ...
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_BINDING_TABLE_READ = 18,
    ...
    SYNC_GEOMETRY_SHADER_SHADER_BINDING_TABLE_READ = 24,
    ...
    SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ = 33,
    SYNC_TASK_SHADER_NV_SHADER_BINDING_TABLE_READ = 34,
    SYNC_TASK_SHADER_NV_SHADER_SAMPLED_READ = 35,
    SYNC_TASK_SHADER_NV_SHADER_STORAGE_READ = 36,
    SYNC_TASK_SHADER_NV_SHADER_STORAGE_WRITE = 37,
    SYNC_TASK_SHADER_NV_UNIFORM_READ = 38,
    SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ = 39,
    SYNC_MESH_SHADER_NV_SHADER_BINDING_TABLE_READ = 40,
    SYNC_MESH_SHADER_NV_SHADER_SAMPLED_READ = 41,
    SYNC_MESH_SHADER_NV_SHADER_STORAGE_READ = 42,
    SYNC_MESH_SHADER_NV_SHADER_STORAGE_WRITE = 43,
    SYNC_MESH_SHADER_NV_UNIFORM_READ = 44,
    ...
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 49,
    SYNC_FRAGMENT_SHADER_SHADER_BINDING_TABLE_READ = 50,
    ...
    SYNC_COMPUTE_SHADER_SHADER_BINDING_TABLE_READ = 61,
    ...
    SYNC_RAY_TRACING_SHADER_SHADER_BINDING_TABLE_READ = 77,
    SYNC_RAY_TRACING_SHADER_SHADER_SAMPLED_READ = 78,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_READ = 79,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_WRITE = 80,
    SYNC_RAY_TRACING_SHADER_UNIFORM_READ = 81,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_READ = 82,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_WRITE = 83,
    SYNC_ACCELERATION_STRUCTURE_BUILD_INDIRECT_COMMAND_READ = 84,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_BINDING_TABLE_READ = 85,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_SAMPLED_READ = 86,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 87,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ = 88,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_WRITE = 89,
    SYNC_ACCELERATION_STRUCTURE_BUILD_UNIFORM_READ = 90,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_READ = 91,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_WRITE = 92,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_READ = 93,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_WRITE = 94,
    SYNC_SUBPASS_SHADING_HUAWEI_INPUT_ATTACHMENT_READ = 95,
    SYNC_HOST_HOST_READ = 96,
    SYNC_HOST_HOST_WRITE = 97,
    SYNC_IMAGE_LAYOUT_TRANSITION = 98,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 99,
};
...
static const SyncStageAccessFlags SYNC_TASK_SHADER_NV_SHADER_BINDING_TABLE_READ_BIT = (SyncStageAccessFlags(1) << SYNC_TASK_SHADER_NV_SHADER_BINDING_TABLE_READ);
...
static const SyncStageAccessFlags SYNC_MESH_SHADER_NV_SHADER_BINDING_TABLE_READ_BIT = (SyncStageAccessFlags(1) << SYNC_MESH_SHADER_NV_SHADER_BINDING_TABLE_READ);
...
static const SyncStageAccessFlags SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_BINDING_TABLE_READ_BIT = (SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_BINDING_TABLE_READ);
...
extern const std::array<SyncStageAccessInfoType, 100> syncStageAccessInfoByStageAccessIndex;
