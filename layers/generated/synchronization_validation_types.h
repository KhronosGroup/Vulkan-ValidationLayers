...
enum SyncStageAccessIndex {
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_SAMPLED_READ = 77,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 78,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ = 79,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_WRITE = 80,
    SYNC_ACCELERATION_STRUCTURE_BUILD_UNIFORM_READ = 81,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_READ = 82,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_WRITE = 83,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_READ = 84,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_WRITE = 85,
    SYNC_SUBPASS_SHADING_HUAWEI_INPUT_ATTACHMENT_READ = 86,
    SYNC_HOST_HOST_READ = 87,
    SYNC_HOST_HOST_WRITE = 88,
    SYNC_IMAGE_LAYOUT_TRANSITION = 89,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 90,
};
...
extern const std::array<SyncStageAccessInfoType, 91> syncStageAccessInfoByStageAccessIndex;
