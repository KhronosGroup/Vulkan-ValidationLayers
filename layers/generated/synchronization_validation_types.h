...
enum SyncStageAccessIndex {
    ...
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 46,
    SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ = 47,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_READ = 48,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE = 49,
    SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV = 50,
    SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV = 51,
    SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV = 52,
};
...
static std::array<SyncStageAccessInfoType, 53> syncStageAccessInfoByStageAccessIndex = { {
    {
