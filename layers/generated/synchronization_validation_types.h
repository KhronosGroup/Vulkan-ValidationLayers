...
enum SyncStageAccessIndex {
    ...
    SYNC_INDEX_INPUT_INDEX_READ = 2,
    SYNC_VERTEX_ATTRIBUTE_INPUT_VERTEX_ATTRIBUTE_READ = 3,
    SYNC_VERTEX_SHADER_ACCELERATION_STRUCTURE_READ = 4,
    ...
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_SAMPLED_READ = 10,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_STORAGE_READ = 11,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_STORAGE_WRITE = 12,
    SYNC_TESSELLATION_CONTROL_SHADER_UNIFORM_READ = 13,
    SYNC_TESSELLATION_EVALUATION_SHADER_ACCELERATION_STRUCTURE_READ = 14,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_SAMPLED_READ = 15,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_READ = 16,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_WRITE = 17,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 18,
    SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ = 19,
    SYNC_GEOMETRY_SHADER_SHADER_SAMPLED_READ = 20,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_READ = 21,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_WRITE = 22,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 23,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 24,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 25,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 26,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 27,
    SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ = 28,
    SYNC_TASK_SHADER_NV_SHADER_SAMPLED_READ = 29,
    SYNC_TASK_SHADER_NV_SHADER_STORAGE_READ = 30,
    SYNC_TASK_SHADER_NV_SHADER_STORAGE_WRITE = 31,
    SYNC_TASK_SHADER_NV_UNIFORM_READ = 32,
    SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ = 33,
    SYNC_MESH_SHADER_NV_SHADER_SAMPLED_READ = 34,
    SYNC_MESH_SHADER_NV_SHADER_STORAGE_READ = 35,
    SYNC_MESH_SHADER_NV_SHADER_STORAGE_WRITE = 36,
    SYNC_MESH_SHADER_NV_UNIFORM_READ = 37,
    SYNC_FRAGMENT_SHADING_RATE_ATTACHMENT_FRAGMENT_SHADING_RATE_ATTACHMENT_READ = 38,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 39,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 40,
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ = 41,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 42,
    SYNC_FRAGMENT_SHADER_SHADER_SAMPLED_READ = 43,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_READ = 44,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_WRITE = 45,
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 46,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 47,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 48,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 49,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 50,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 51,
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ = 52,
    ...
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 56,
    SYNC_COPY_TRANSFER_READ = 57,
    SYNC_COPY_TRANSFER_WRITE = 58,
    SYNC_RESOLVE_TRANSFER_READ = 59,
    SYNC_RESOLVE_TRANSFER_WRITE = 60,
    SYNC_BLIT_TRANSFER_READ = 61,
    SYNC_BLIT_TRANSFER_WRITE = 62,
    SYNC_CLEAR_TRANSFER_WRITE = 63,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 64,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 65,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 66,
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_WRITE = 71,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_SAMPLED_READ = 72,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 73,
    SYNC_HOST_HOST_READ = 74,
    SYNC_HOST_HOST_WRITE = 75,
    SYNC_IMAGE_LAYOUT_TRANSITION = 76,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 77,
};
...
extern const std::array<SyncStageAccessInfoType, 78> syncStageAccessInfoByStageAccessIndex;
