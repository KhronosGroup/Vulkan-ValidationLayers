...
enum SyncStageAccessIndex {
    ...
    SYNC_VERTEX_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 4,
    SYNC_VERTEX_SHADER_SHADER_READ = 5,
    SYNC_VERTEX_SHADER_SHADER_WRITE = 6,
    SYNC_VERTEX_SHADER_UNIFORM_READ = 7,
    SYNC_TESSELLATION_CONTROL_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 8,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_READ = 9,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_WRITE = 10,
    SYNC_TESSELLATION_CONTROL_SHADER_UNIFORM_READ = 11,
    SYNC_TESSELLATION_EVALUATION_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 12,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_READ = 13,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_WRITE = 14,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 15,
    SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 16,
    SYNC_GEOMETRY_SHADER_SHADER_READ = 17,
    SYNC_GEOMETRY_SHADER_SHADER_WRITE = 18,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 19,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 20,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 21,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 22,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 23,
    SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ_KHR = 24,
    SYNC_TASK_SHADER_NV_SHADER_READ = 25,
    SYNC_TASK_SHADER_NV_SHADER_WRITE = 26,
    SYNC_TASK_SHADER_NV_UNIFORM_READ = 27,
    SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ_KHR = 28,
    SYNC_MESH_SHADER_NV_SHADER_READ = 29,
    SYNC_MESH_SHADER_NV_SHADER_WRITE = 30,
    SYNC_MESH_SHADER_NV_UNIFORM_READ = 31,
    SYNC_SHADING_RATE_IMAGE_NV_SHADING_RATE_IMAGE_READ_NV = 32,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 33,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 34,
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 35,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 36,
    SYNC_FRAGMENT_SHADER_SHADER_READ = 37,
    SYNC_FRAGMENT_SHADER_SHADER_WRITE = 38,
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 39,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 40,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 41,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 42,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 43,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 44,
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ_KHR = 45,
    SYNC_COMPUTE_SHADER_SHADER_READ = 46,
    SYNC_COMPUTE_SHADER_SHADER_WRITE = 47,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 48,
    SYNC_TRANSFER_TRANSFER_READ = 49,
    SYNC_TRANSFER_TRANSFER_WRITE = 50,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 51,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 52,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 53,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_READ = 54,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_WRITE = 55,
    SYNC_RAY_TRACING_SHADER_KHR_UNIFORM_READ = 56,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_ACCELERATION_STRUCTURE_WRITE_KHR = 57,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_SHADER_READ = 58,
    SYNC_HOST_HOST_READ = 59,
    SYNC_HOST_HOST_WRITE = 60,
    SYNC_IMAGE_LAYOUT_TRANSITION = 61,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 62,
};
...
static const SyncStageAccessFlags SYNC_VERTEX_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_VERTEX_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_TESSELLATION_CONTROL_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_TESSELLATION_CONTROL_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_TESSELLATION_EVALUATION_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_TESSELLATION_EVALUATION_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR = (SyncStageAccessFlags(1) << SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ_KHR);
...
static const SyncStageAccessFlags SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_SHADER_READ_BIT = (SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_SHADER_READ);
...
extern const std::array<SyncStageAccessInfoType, 63> syncStageAccessInfoByStageAccessIndex;
...
static const SyncStageAccessFlags syncStageAccessReadMask = ( //  Mask of all read StageAccess bits
    ...
    SYNC_TASK_SHADER_NV_ACCELERATION_STRUCTURE_READ_BIT_KHR |
    SYNC_TASK_SHADER_NV_SHADER_READ_BIT |
    SYNC_TASK_SHADER_NV_UNIFORM_READ_BIT |
    SYNC_MESH_SHADER_NV_ACCELERATION_STRUCTURE_READ_BIT_KHR |
    ...
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR |
    ...
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ_BIT_KHR |
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_SHADER_READ_BIT |
