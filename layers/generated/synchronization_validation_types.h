...
enum SyncStageAccessIndex {
    ...
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 37,
    SYNC_FRAGMENT_SHADER_SHADER_SAMPLED_READ = 38,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_READ = 39,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_WRITE = 40,
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 41,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 42,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 43,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 44,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 45,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 46,
    SYNC_COMPUTE_SHADER_SHADER_SAMPLED_READ = 47,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_READ = 48,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_WRITE = 49,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 50,
    SYNC_COPY_TRANSFER_READ = 51,
    SYNC_COPY_TRANSFER_WRITE = 52,
    SYNC_RESOLVE_TRANSFER_READ = 53,
    SYNC_RESOLVE_TRANSFER_WRITE = 54,
    SYNC_BLIT_TRANSFER_READ = 55,
    SYNC_BLIT_TRANSFER_WRITE = 56,
    SYNC_CLEAR_TRANSFER_WRITE = 57,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 58,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 59,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 60,
    SYNC_RAY_TRACING_SHADER_ACCELERATION_STRUCTURE_READ = 61,
    SYNC_RAY_TRACING_SHADER_SHADER_SAMPLED_READ = 62,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_READ = 63,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_WRITE = 64,
    SYNC_RAY_TRACING_SHADER_UNIFORM_READ = 65,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_READ = 66,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_WRITE = 67,
    SYNC_ACCELERATION_STRUCTURE_BUILD_INDIRECT_COMMAND_READ = 68,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_SAMPLED_READ = 69,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 70,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ = 71,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_WRITE = 72,
    SYNC_ACCELERATION_STRUCTURE_BUILD_UNIFORM_READ = 73,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_READ = 74,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_WRITE = 75,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_READ = 76,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_WRITE = 77,
