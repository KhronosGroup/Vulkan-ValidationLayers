...
enum SyncStageAccessIndex {
    ...
    SYNC_RAY_TRACING_SHADER_KHR_UNIFORM_READ = 47,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_READ = 48,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_WRITE = 49,
    SYNC_RAY_TRACING_SHADER_KHR_ACCELERATION_STRUCTURE_READ_KHR = 50,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_ACCELERATION_STRUCTURE_READ_KHR = 51,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_ACCELERATION_STRUCTURE_WRITE_KHR = 52,
};
