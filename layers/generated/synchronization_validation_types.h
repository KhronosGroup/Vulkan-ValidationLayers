...
enum SyncStageAccessIndex {
    ...
    SYNC_VERTEX_SHADER_UNIFORM_READ = 4,
    SYNC_VERTEX_SHADER_SHADER_READ = 5,
    SYNC_VERTEX_SHADER_SHADER_WRITE = 6,
    SYNC_TESSELLATION_CONTROL_SHADER_UNIFORM_READ = 7,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_READ = 8,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_WRITE = 9,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 10,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_READ = 11,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_WRITE = 12,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 13,
    SYNC_GEOMETRY_SHADER_SHADER_READ = 14,
    SYNC_GEOMETRY_SHADER_SHADER_WRITE = 15,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 16,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 17,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 18,
    SYNC_TASK_SHADER_NV_UNIFORM_READ = 19,
    SYNC_TASK_SHADER_NV_SHADER_READ = 20,
    SYNC_TASK_SHADER_NV_SHADER_WRITE = 21,
    SYNC_MESH_SHADER_NV_UNIFORM_READ = 22,
    SYNC_MESH_SHADER_NV_SHADER_READ = 23,
    SYNC_MESH_SHADER_NV_SHADER_WRITE = 24,
    ...
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 28,
    SYNC_FRAGMENT_SHADER_SHADER_READ = 29,
    SYNC_FRAGMENT_SHADER_SHADER_WRITE = 30,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 31,
    ...
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 35,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 36,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 37,
    SYNC_COMPUTE_SHADER_SHADER_READ = 38,
    SYNC_COMPUTE_SHADER_SHADER_WRITE = 39,
    SYNC_TRANSFER_TRANSFER_READ = 40,
    SYNC_TRANSFER_TRANSFER_WRITE = 41,
    SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX = 42,
    SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX = 43,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 44,
    SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ = 45,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_READ = 46,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE = 47,
    SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV = 48,
    SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV = 49,
    SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV = 50,
...
enum SyncStageAccessFlagBits : SyncStageAccessFlags {
    ...
    SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_READ_BIT_NVX = SyncStageAccessFlags(1) << SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX,
    SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_WRITE_BIT_NVX = SyncStageAccessFlags(1) << SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX,
    ...
    SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ_BIT = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_READ_BIT = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_NV_SHADER_READ,
    SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE,
    SYNC_RAY_TRACING_SHADER_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV,
    SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV = SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV,
    SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_WRITE_BIT_NV = SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV,
...
static std::map<SyncStageAccessFlags, SyncStageAccessIndex> syncStageAccessIndexByStageAccessBit  = {
    ...
    { SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_READ_BIT_NVX, SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX },
    { SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_WRITE_BIT_NVX, SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX },
    ...
    { SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ_BIT, SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ },
    { SYNC_RAY_TRACING_SHADER_NV_SHADER_READ_BIT, SYNC_RAY_TRACING_SHADER_NV_SHADER_READ },
    { SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE_BIT, SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE },
    { SYNC_RAY_TRACING_SHADER_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV, SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV },
    { SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV, SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV },
    { SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_WRITE_BIT_NV, SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV },
...
static std::array<SyncStageAccessInfoType, 55> syncStageAccessInfoByStageAccessIndex = { {
    ...
    {
        "SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX",
        VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX,
        VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX,
        SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX,
        SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_READ_BIT_NVX

    },
    {
        "SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX",
        VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX,
        VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX,
        SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX,
        SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_WRITE_BIT_NVX
    ...
    {
        "SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV,
        VK_ACCESS_UNIFORM_READ_BIT,
        SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ,
        SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ_BIT

    },
    {
        "SYNC_RAY_TRACING_SHADER_NV_SHADER_READ",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV,
        VK_ACCESS_SHADER_READ_BIT,
        SYNC_RAY_TRACING_SHADER_NV_SHADER_READ,
        SYNC_RAY_TRACING_SHADER_NV_SHADER_READ_BIT

    },
    {
        "SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV,
        VK_ACCESS_SHADER_WRITE_BIT,
        SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE,
        SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE_BIT

    },
    {
        "SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV,
        VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV,
        SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV,
        SYNC_RAY_TRACING_SHADER_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV

    },
    {
        "SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV",
        VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV,
        VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV,
        SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV,
        SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_READ_BIT_NV

    },
    {
        "SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV",
        VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV,
        VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV,
        SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV,
        SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_WRITE_BIT_NV
...
static std::map<VkAccessFlags, SyncStageAccessFlags> syncStageAccessMaskByAccessBit = {
    ...
    { VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX, SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_READ_BIT_NVX},
    { VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX, SYNC_COMMAND_PROCESS_BIT_NVX_COMMAND_PROCESS_WRITE_BIT_NVX},
    ...
    { VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV, SYNC_ACCELERATION_STRUCTURE_BUILD_BIT_NV_ACCELERATION_STRUCTURE_WRITE_BIT_NV},
...
static std::map<VkPipelineStageFlags, std::map<VkAccessFlags, SyncStageAccessIndex>> syncStageAccessIndexByStageAndAccess = {
    ...
    { VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX, {
        { VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX, SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_READ_NVX },
        { VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX, SYNC_COMMAND_PROCESS_NVX_COMMAND_PROCESS_WRITE_NVX }
    } },
    { VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT, {
    ...
    { VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV, {
        { VK_ACCESS_UNIFORM_READ_BIT, SYNC_RAY_TRACING_SHADER_NV_UNIFORM_READ },
        { VK_ACCESS_SHADER_READ_BIT, SYNC_RAY_TRACING_SHADER_NV_SHADER_READ },
        { VK_ACCESS_SHADER_WRITE_BIT, SYNC_RAY_TRACING_SHADER_NV_SHADER_WRITE },
        { VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV, SYNC_RAY_TRACING_SHADER_NV_ACCELERATION_STRUCTURE_READ_NV }
    } },
    { VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV, {
    ...
    { VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV, {
        { VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV, SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_READ_NV },
        { VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV, SYNC_ACCELERATION_STRUCTURE_BUILD_NV_ACCELERATION_STRUCTURE_WRITE_NV }
    } },
};
...
static std::map<VkPipelineStageFlagBits, VkPipelineStageFlags> syncLogicallyEarlierStages = {
    ...
    { VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT},
    { VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT},
    { VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT},
    { VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT},
    { VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT, (
        VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT |
        VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT |
        VK_PIPELINE_STAGE_VERTEX_INPUT_BIT |
...
static std::map<VkPipelineStageFlagBits, VkPipelineStageFlags> syncLogicallyLaterStages = {
    ...
    { VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX, VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT},
    ...
    { VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV, VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT},
