...
enum SyncStageAccessIndex {
    ...
    SYNC_SUBPASS_SHADING_HUAWEI_INPUT_ATTACHMENT_READ = 96,
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_READ_NV = 97,
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_WRITE_NV = 98,
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_READ_EXT = 99,
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_WRITE_EXT = 100,
    SYNC_HOST_HOST_READ = 101,
    SYNC_HOST_HOST_WRITE = 102,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 103,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 104,
    SYNC_IMAGE_LAYOUT_TRANSITION = 105,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 106,
};
