...
enum SyncStageAccessIndex {
    ...
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_READ_EXT = 83,
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_WRITE_EXT = 84,
    ...
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_READ_NV = 89,
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_WRITE_NV = 90,
    SYNC_SUBPASS_SHADING_HUAWEI_INPUT_ATTACHMENT_READ = 91,
