...
enum SyncStageAccessIndex {
    ...
    SYNC_ACCELERATION_STRUCTURE_COPY_ACCELERATION_STRUCTURE_READ = 92,
    SYNC_ACCELERATION_STRUCTURE_COPY_ACCELERATION_STRUCTURE_WRITE = 93,
    SYNC_ACCELERATION_STRUCTURE_COPY_TRANSFER_READ = 94,
    SYNC_ACCELERATION_STRUCTURE_COPY_TRANSFER_WRITE = 95,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_READ = 96,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_WRITE = 97,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_READ = 98,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_WRITE = 99,
    SYNC_SUBPASS_SHADING_HUAWEI_INPUT_ATTACHMENT_READ = 100,
    ...
    SYNC_HOST_HOST_READ = 105,
    SYNC_HOST_HOST_WRITE = 106,
