...
bool ValidateMemoryHeapFlags(const char *api_name, const ParameterName &parameter_name, VkMemoryHeapFlags value, const char *vuid) const;
...
bool ValidateQueueFlags(const char *api_name, const ParameterName &parameter_name, VkQueueFlags value, const char *vuid) const;
...
bool ValidateMemoryPropertyFlags(const char *api_name, const ParameterName &parameter_name, VkMemoryPropertyFlags value, const char *vuid) const;
...
bool ValidatePeerMemoryFeatureFlags(const char *api_name, const ParameterName &parameter_name, VkPeerMemoryFeatureFlags value, const char *vuid) const;
...
bool ValidateExternalMemoryFeatureFlags(const char *api_name, const ParameterName &parameter_name, VkExternalMemoryFeatureFlags value, const char *vuid) const;
...
bool ValidateExternalSemaphoreFeatureFlags(const char *api_name, const ParameterName &parameter_name, VkExternalSemaphoreFeatureFlags value, const char *vuid) const;
...
bool ValidateExternalFenceFeatureFlags(const char *api_name, const ParameterName &parameter_name, VkExternalFenceFeatureFlags value, const char *vuid) const;
...
bool ValidatePointClippingBehavior(const char *api_name, const ParameterName &parameter_name, VkPointClippingBehavior value, const char *vuid) const;
...
bool ValidateRayTracingShaderGroupTypeKHR(const char *api_name, const ParameterName &parameter_name, VkRayTracingShaderGroupTypeKHR value, const char *vuid) const;
bool ValidateGeometryTypeKHR(const char *api_name, const ParameterName &parameter_name, VkGeometryTypeKHR value, const char *vuid) const;
bool ValidateAccelerationStructureTypeKHR(const char *api_name, const ParameterName &parameter_name, VkAccelerationStructureTypeKHR value, const char *vuid) const;
bool ValidateGeometryFlagsKHR(const char *api_name, const ParameterName &parameter_name, VkGeometryFlagsKHR value, const char *vuid) const;
bool ValidateGeometryInstanceFlagsKHR(const char *api_name, const ParameterName &parameter_name, VkGeometryInstanceFlagsKHR value, const char *vuid) const;
bool ValidateBuildAccelerationStructureFlagsKHR(const char *api_name, const ParameterName &parameter_name, VkBuildAccelerationStructureFlagsKHR value, const char *vuid) const;
bool ValidateCopyAccelerationStructureModeKHR(const char *api_name, const ParameterName &parameter_name, VkCopyAccelerationStructureModeKHR value, const char *vuid) const;
bool ValidateDriverId(const char *api_name, const ParameterName &parameter_name, VkDriverId value, const char *vuid) const;
bool ValidateShaderFloatControlsIndependence(const char *api_name, const ParameterName &parameter_name, VkShaderFloatControlsIndependence value, const char *vuid) const;
bool ValidateSubgroupFeatureFlags(const char *api_name, const ParameterName &parameter_name, VkSubgroupFeatureFlags value, const char *vuid) const;
...
bool ValidateToolPurposeFlagsEXT(const char *api_name, const ParameterName &parameter_name, VkToolPurposeFlagsEXT value, const char *vuid) const;
