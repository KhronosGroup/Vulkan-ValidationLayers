...
static const std::array<SyncStageAccessInfoType, 84> variable = { {
	{
	...
	{
		"SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_READ",
		VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR,
		VK_ACCESS_2_SHADER_READ_BIT,
		SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_READ,
	...
	{
		"SYNC_ACCELERATION_STRUCTURE_COPY_SHADER_BINDING_TABLE_READ",
	...
	{
		"SYNC_RAY_TRACING_SHADER_SHADER_READ",
		VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR,
		VK_ACCESS_2_SHADER_READ_BIT,
		SYNC_RAY_TRACING_SHADER_SHADER_READ,
	...
	{
		"SYNC_RAY_TRACING_SHADER_SHADER_WRITE",
		VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR,
		VK_ACCESS_2_SHADER_WRITE_BIT,
		SYNC_RAY_TRACING_SHADER_SHADER_WRITE,
	...
	{
		"SYNC_TRANSFORM_FEEDBACK_EXT_INVOCATION_MASK_READ_HUAWEI",
	...
	{
		"SYNC_MICROMAP_BUILD_EXT_SHADER_READ",
		VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT,
		VK_ACCESS_2_SHADER_READ_BIT,
		SYNC_MICROMAP_BUILD_EXT_SHADER_READ,
	...
	{
		"SYNC_ALL_TRANSFER_TRANSFER_READ",
	...
	{
		"SYNC_ALL_TRANSFER_TRANSFER_WRITE",
		VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT,
		VK_ACCESS_2_TRANSFER_WRITE_BIT,
		SYNC_ALL_TRANSFER_TRANSFER_WRITE,
	...
	{
		"SYNC_MESH_SHADER_EXT_SHADER_READ",
		VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT,
		VK_ACCESS_2_SHADER_READ_BIT,
		SYNC_MESH_SHADER_EXT_SHADER_READ,
	...
	{
		"SYNC_MESH_SHADER_EXT_SHADER_WRITE",
		VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT,
		VK_ACCESS_2_SHADER_WRITE_BIT,
		SYNC_MESH_SHADER_EXT_SHADER_WRITE,
	...
	{
		"SYNC_TASK_SHADER_EXT_SHADER_READ",
		VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT,
		VK_ACCESS_2_SHADER_READ_BIT,
		SYNC_TASK_SHADER_EXT_SHADER_READ,
	...
	{
		"SYNC_TASK_SHADER_EXT_SHADER_WRITE",
		VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT,
		VK_ACCESS_2_SHADER_WRITE_BIT,
		SYNC_TASK_SHADER_EXT_SHADER_WRITE,
