...
VKAPI_ATTR VkResult VKAPI_CALL CreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
    ...
    auto instance_dispatch = std::make_unique<DispatchObject>(pCreateInfo);
    ...
    layer_data_map[GetDispatchKey(*pInstance)] = instance_dispatch.get();
    for (auto* vo : instance_dispatch->object_dispatch) {
        auto lock = vo->WriteLock();
    ...
    layer_data_map[GetDispatchKey(*pInstance)] = instance_dispatch.release();
    return result;
}
...
VKAPI_ATTR void VKAPI_CALL DestroyInstance(VkInstance instance, const VkAllocationCallbacks* pAllocator) {
    ...
    auto instance_dispatch = GetLayerDataPtr(key, layer_data_map);
    ...
    for (auto* vo : instance_dispatch->aborted_object_dispatch) {
        auto lock = vo->WriteLock();
        vo->PreCallRecordDestroyInstance(instance, pAllocator, record_obj);
    }
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDevice(VkPhysicalDevice gpu, const VkDeviceCreateInfo* pCreateInfo,
    ...
    auto instance_dispatch = GetLayerDataPtr(GetDispatchKey(gpu), layer_data_map);
    ...
    auto device_dispatch = std::make_unique<DispatchObject>(instance_dispatch, gpu, pCreateInfo);
    ...
    layer_data_map[GetDispatchKey(*pDevice)] = device_dispatch.get();
    for (auto* vo : instance_dispatch->object_dispatch) {
        auto lock = vo->WriteLock();
...
VKAPI_ATTR void VKAPI_CALL DestroyDevice(VkDevice device, const VkAllocationCallbacks* pAllocator) {
    ...
    auto device_dispatch = GetLayerDataPtr(key, layer_data_map);
    ...
    auto instance_dispatch = GetLayerDataPtr(GetDispatchKey(device_dispatch->physical_device), layer_data_map);
    instance_dispatch->debug_report->device_created--;

    layer_data_map.erase(key);
    delete device_dispatch;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint32_t* pToolCount,
    ...
    auto instance_dispatch = GetLayerDataPtr(GetDispatchKey(physicalDevice), layer_data_map);
    bool skip = false;
