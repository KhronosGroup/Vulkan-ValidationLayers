...
bool StatelessValidation::ValidatePipelineTessellationStateCreateInfo(const VkPipelineTessellationStateCreateInfo *create_info,
    ...
    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ...
                                 "VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO", create_info,
    ...
    const VkStructureType allowed_structs[] = {VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO};

    skip |= validate_struct_pnext(
        "vkCreateGraphicsPipelines", ParameterName("pCreateInfos[%i].pTessellationState->pNext", ParameterName::IndexVector{index}),
        "VkPipelineTessellationDomainOriginStateCreateInfo", create_info->pNext, ARRAY_SIZE(allowed_structs), allowed_structs,
    ...
    skip |= validate_reserved_flags("vkCreateGraphicsPipelines",
                                    ...
                                    create_info->flags, "VUID-VkPipelineTessellationStateCreateInfo-flags-zerobitmask");

    return skip;
}

// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineVertexInputStateCreateInfo(const VkPipelineVertexInputStateCreateInfo *create_info,
                                                                     uint32_t index) const {
    bool skip = false;

    const VkStructureType allowed_structs[] = {VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT};
    skip |= validate_struct_pnext(
        "vkCreateGraphicsPipelines", ParameterName("pCreateInfos[%i].pVertexInputState->pNext", ParameterName::IndexVector{index}),
        "VkPipelineVertexInputDivisorStateCreateInfoEXT", create_info->pNext, ARRAY_SIZE(allowed_structs), allowed_structs,
    ...
    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ...
                                 "VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO", create_info,
    ...
    skip |= validate_array(
        ...
        "pCreateInfos[i].pVertexInputState->pVertexBindingDescriptions", create_info->vertexBindingDescriptionCount,
        &create_info->pVertexBindingDescriptions, false, true, kVUIDUndefined,
    ...
    skip |= validate_array(
        ...
        "pCreateInfos[i]->pVertexAttributeDescriptions", create_info->vertexAttributeDescriptionCount,
        &create_info->pVertexAttributeDescriptions, false, true, kVUIDUndefined,
        "VUID-VkPipelineVertexInputStateCreateInfo-pVertexAttributeDescriptions-parameter");

    if (create_info->pVertexBindingDescriptions != nullptr) {
        for (uint32_t vertex_binding_description_index = 0;
             vertex_binding_description_index < create_info->vertexBindingDescriptionCount; ++vertex_binding_description_index) {
            skip |=
                validate_ranged_enum("vkCreateGraphicsPipelines",
                                     ...
                                     create_info->pVertexBindingDescriptions[vertex_binding_description_index].inputRate,
                                     "VUID-VkVertexInputBindingDescription-inputRate-parameter");
        }
    }

    if (create_info->pVertexAttributeDescriptions != nullptr) {
        for (uint32_t vertex_attribute_description_index = 0;
             vertex_attribute_description_index < create_info->vertexAttributeDescriptionCount;
             ++vertex_attribute_description_index) {
            const VkFormat format = create_info->pVertexAttributeDescriptions[vertex_attribute_description_index].format;
            skip |= validate_ranged_enum(
                ...
                "VkFormat", AllVkFormatEnums, create_info->pVertexAttributeDescriptions[vertex_attribute_description_index].format,
    ...
    skip |= validate_reserved_flags("vkCreateGraphicsPipelines",
                                    ...
                                    create_info->flags, "VUID-VkPipelineVertexInputStateCreateInfo-flags-zerobitmask");

    return skip;
}

// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineViewportStateCreateInfo(const VkPipelineViewportStateCreateInfo *create_info,
                                                                  uint32_t index) const {
    bool skip = false;
    ...
    skip |= validate_struct_type(
        ...
        "VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO", create_info, VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO,
        false, kVUIDUndefined, "VUID-VkPipelineViewportStateCreateInfo-sType-sType");

    const VkStructureType allowed_structs[] = {
    ...
    skip |= validate_struct_pnext(
        ...
        create_info->pNext, ARRAY_SIZE(allowed_structs), allowed_structs, GeneratedVulkanHeaderVersion,
    ...
    skip |= validate_reserved_flags("vkCreateGraphicsPipelines",
                                    ...
                                    create_info->flags, "VUID-VkPipelineViewportStateCreateInfo-flags-zerobitmask");

    return skip;
}

// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineMultisampleStateCreateInfo(const VkPipelineMultisampleStateCreateInfo *create_info,
                                                                     uint32_t index) const {
    bool skip = false;

    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ParameterName("pCreateInfos[%i].pMultisampleState", ParameterName::IndexVector{index}),
                                 "VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO", create_info,
    ...
    const VkStructureType allowed_structs[] = {VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV,
    ...
    skip |= validate_reserved_flags("vkCreateGraphicsPipelines",
                                    ...
                                    create_info->flags, "VUID-VkPipelineMultisampleStateCreateInfo-flags-zerobitmask");
    ...
    skip |=
        validate_bool32("vkCreateGraphicsPipelines",
                        ...
                        create_info->sampleShadingEnable);
    ...
    skip |=
        validate_array("vkCreateGraphicsPipelines",
                       ...
                       create_info->rasterizationSamples, &create_info->pSampleMask, true, false, kVUIDUndefined, kVUIDUndefined);

    skip |=
        validate_flags("vkCreateGraphicsPipelines",
                       ParameterName("pCreateInfos[%i].pMultisampleState->rasterizationSamples", ParameterName::IndexVector{index}),
                       "VkSampleCountFlagBits", AllVkSampleCountFlagBits, create_info->rasterizationSamples, kRequiredSingleBit,
...
// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineColorBlendStateCreateInfo(const VkPipelineColorBlendStateCreateInfo *create_info,
                                                                    uint32_t index) const {
    bool skip = false;

    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ParameterName("pCreateInfos[%i].pColorBlendState", ParameterName::IndexVector{index}),
                                 "VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO", create_info,
    ...
    const VkStructureType allowed_structs[] = {VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT,
                                               VK_STRUCTURE_TYPE_PIPELINE_COLOR_WRITE_CREATE_INFO_EXT};

    skip |= validate_struct_pnext(
        "vkCreateGraphicsPipelines", ParameterName("pCreateInfos[%i].pColorBlendState->pNext", ParameterName::IndexVector{index}),
        "VkPipelineColorBlendAdvancedStateCreateInfoEXT, VkPipelineColorWriteCreateInfoEXT", create_info->pNext,
        ARRAY_SIZE(allowed_structs), allowed_structs, GeneratedVulkanHeaderVersion,
        "VUID-VkPipelineColorBlendStateCreateInfo-pNext-pNext", "VUID-VkPipelineColorBlendStateCreateInfo-sType-unique");
    ...
    skip |= validate_flags("vkCreateGraphicsPipelines",
                           ...
                           create_info->flags, kOptionalFlags, "VUID-VkPipelineColorBlendStateCreateInfo-flags-parameter");
    ...
    skip |= validate_array("vkCreateGraphicsPipelines",
                           ...
                           create_info->attachmentCount, &create_info->pAttachments, false, true, kVUIDUndefined, kVUIDUndefined);
    return skip;
}

// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineDepthStencilStateCreateInfo(const VkPipelineDepthStencilStateCreateInfo *create_info,
                                                                      uint32_t index) const {
    bool skip = false;

    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ParameterName("pCreateInfos[%i].pDepthStencilState", ParameterName::IndexVector{index}),
                                 "VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO", create_info,
    ...
    skip |= validate_struct_pnext("vkCreateGraphicsPipelines",
                                  ...
                                  nullptr, create_info->pNext, 0, nullptr, GeneratedVulkanHeaderVersion,
    ...
    skip |= validate_flags("vkCreateGraphicsPipelines",
                           ...
                           create_info->flags, kOptionalFlags, "VUID-VkPipelineDepthStencilStateCreateInfo-flags-parameter");
    ...
    skip |= validate_ranged_enum(
        ...
        AllVkCompareOpEnums, create_info->depthCompareOp, "VUID-VkPipelineDepthStencilStateCreateInfo-depthCompareOp-parameter");
    ...
    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->front.failOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->front.failOp, "VUID-VkStencilOpState-failOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->front.passOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->front.passOp, "VUID-VkStencilOpState-passOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->front.depthFailOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->front.depthFailOp, "VUID-VkStencilOpState-depthFailOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->front.compareOp", ParameterName::IndexVector{index}), "VkCompareOp",
        AllVkCompareOpEnums, create_info->front.compareOp, "VUID-VkPipelineDepthStencilStateCreateInfo-depthCompareOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->back.failOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->back.failOp, "VUID-VkStencilOpState-failOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->back.passOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->back.passOp, "VUID-VkStencilOpState-passOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->back.depthFailOp", ParameterName::IndexVector{index}), "VkStencilOp",
        AllVkStencilOpEnums, create_info->back.depthFailOp, "VUID-VkStencilOpState-depthFailOp-parameter");

    skip |= validate_ranged_enum(
        "vkCreateGraphicsPipelines",
        ParameterName("pCreateInfos[%i].pDepthStencilState->back.compareOp", ParameterName::IndexVector{index}), "VkCompareOp",
        AllVkCompareOpEnums, create_info->back.compareOp, "VUID-VkPipelineDepthStencilStateCreateInfo-depthCompareOp-parameter");

    return skip;
}

// TODO Issue 4847 - Move logic to be autogenerated
bool StatelessValidation::ValidatePipelineInputAssemblyStateCreateInfo(const VkPipelineInputAssemblyStateCreateInfo *create_info,
                                                                       uint32_t index) const {
    bool skip = false;

    skip |= validate_struct_type("vkCreateGraphicsPipelines",
                                 ParameterName("pCreateInfos[%i].pInputAssemblyState", ParameterName::IndexVector{index}),
                                 "VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO", create_info,
