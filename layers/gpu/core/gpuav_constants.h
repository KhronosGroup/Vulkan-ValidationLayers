...
inline constexpr u32 indices_count = 16384;
...
inline constexpr u32 stream_output_flags_offset = 0;

// Values stored at output_flags_offset
inline constexpr u32 inst_buffer_oob_enabled = 0x1;

// The 2nd member of the debug output buffer contains the next available word
// in the data stream to be written. Shaders will atomically read and update
// this value so as not to overwrite each others records. This value must be
// initialized to zero
inline constexpr u32 stream_output_size_offset = 1;
...
inline constexpr u32 stream_output_data_offset = 2;
