...
static void
RecordTransitionImageLayout(Validator& gpuav, vvl::CommandBuffer& cb_state, const sync_utils::ImageBarrier& mem_barrier)
{
...
static void TransitionImageLayouts(Validator&                   gpuav,
...
static bool VerifyImageLayoutRange(const Validator&          gpuav,
...
{
    bool skip = false;
    if (!gpuav.gpuav_settings.validate_image_layout)
        return skip;
    ...
    sparse_container::parallel_iterator<const GlobalImageLayoutRangeMap> current_layout(
        empty_map, *global_range_map, pos->first.begin);
    while (pos != end)
    {
...
static void RecordCmdBlitImage(Validator&        gpuav,
...
static void RecordCmdWaitEvents2(Validator&              gpuav,
                                 VkCommandBuffer         commandBuffer,
                                 uint32_t                eventCount,
...
bool Validator::VerifyImageLayout(const vvl::CommandBuffer& cb_state,
                                  ...
                                  bool*                     error) const
{
    ...
    return VerifyImageLayoutRange(*this,
                                  cb_state,
...
bool Validator::ValidateProtectedBuffer(const vvl::CommandBuffer& cb_state,
...
bool Validator::ValidateUnprotectedBuffer(const vvl::CommandBuffer& cb_state,
                                          const vvl::Buffer&        buffer_state,
                                          const Location&           buffer_loc,
                                          const char*               vuid,
                                          const char*               more_message) const
...
bool Validator::ValidateProtectedImage(const vvl::CommandBuffer& cb_state,
                                       const vvl::Image&         image_state,
                                       const Location&           loc,
                                       const char*               vuid,
                                       const char*               more_message) const
...
bool Validator::ValidateUnprotectedImage(const vvl::CommandBuffer& cb_state,
                                         const vvl::Image&         image_state,
                                         const Location&           loc,
                                         const char*               vuid,
                                         const char*               more_message) const
...
void Validator::PostCallRecordCreateImage(VkDevice                     device,
...
void Validator::PreCallRecordDestroyImage(VkDevice                     device,
                                          VkImage                      image,
                                          const VkAllocationCallbacks* pAllocator,
                                          const RecordObject&          record_obj)
{
...
void Validator::PreCallRecordCmdClearColorImage(VkCommandBuffer                commandBuffer,
                                                VkImage                        image,
...
void Validator::PreCallRecordCmdClearDepthStencilImage(VkCommandBuffer                 commandBuffer,
                                                       VkImage                         image,
                                                       VkImageLayout                   imageLayout,
...
void Validator::PreCallRecordCmdClearAttachments(VkCommandBuffer          commandBuffer,
...
void Validator::PostCallRecordTransitionImageLayout(VkDevice                               device,
...
void Validator::PostCallRecordTransitionImageLayoutEXT(VkDevice                                  device,
                                                       uint32_t                                  transitionCount,
...
void Validator::PreCallRecordCmdCopyImage(VkCommandBuffer     commandBuffer,
                                          VkImage             srcImage,
                                          VkImageLayout       srcImageLayout,
                                          VkImage             dstImage,
                                          VkImageLayout       dstImageLayout,
                                          ...
                                          const RecordObject& record_obj)
{
    BaseClass::PreCallRecordCmdCopyImage(
...
void Validator::PreCallRecordCmdCopyImage2KHR(VkCommandBuffer            commandBuffer,
...
void Validator::PreCallRecordCmdCopyImage2(VkCommandBuffer         commandBuffer,
                                           ...
                                           const RecordObject&     record_obj)
{
    ...
    if (cb_state_ptr && src_image_state && dst_image_state)
    {
        ...
        {
            cb_state_ptr->SetImageInitialLayout(
...
void Validator::PreCallRecordCmdCopyImageToBuffer(VkCommandBuffer          commandBuffer,
                                                  VkImage                  srcImage,
                                                  VkImageLayout            srcImageLayout,
                                                  VkBuffer                 dstBuffer,
                                                  uint32_t                 regionCount,
...
void Validator::PreCallRecordCmdCopyBufferToImage(VkCommandBuffer          commandBuffer,
                                                  VkBuffer                 srcBuffer,
                                                  VkImage                  dstImage,
                                                  VkImageLayout            dstImageLayout,
                                                  uint32_t                 regionCount,
...
void Validator::PreCallRecordCmdBlitImage(VkCommandBuffer     commandBuffer,
                                          VkImage             srcImage,
                                          VkImageLayout       srcImageLayout,
                                          VkImage             dstImage,
                                          VkImageLayout       dstImageLayout,
                                          ...
                                          const RecordObject& record_obj)
{
    ...
    RecordCmdBlitImage(
        *this, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions, filter);
}

void Validator::PreCallRecordCmdBlitImage2KHR(VkCommandBuffer            commandBuffer,
...
void Validator::PreCallRecordCmdBlitImage2(VkCommandBuffer            commandBuffer,
                                           const VkBlitImageInfo2KHR* pBlitImageInfo,
                                           const RecordObject&        record_obj)
{
    BaseClass::PreCallRecordCmdBlitImage2(commandBuffer, pBlitImageInfo, record_obj);
    RecordCmdBlitImage(*this,
                       commandBuffer,
...
void Validator::PostCallRecordBindImageMemory(
...
void Validator::PostCallRecordBindImageMemory2(VkDevice                     device,
...
void Validator::PostCallRecordBindImageMemory2KHR(VkDevice                     device,
                                                  uint32_t                     bindInfoCount,
                                                  const VkBindImageMemoryInfo* pBindInfos,
                                                  const RecordObject&          record_obj)
{
...
void Validator::PreCallRecordCmdWaitEvents(VkCommandBuffer              commandBuffer,
                                           uint32_t                     eventCount,
                                           const VkEvent*               pEvents,
                                           ...
                                           const RecordObject&          record_obj)
{
    ...
    TransitionImageLayouts(
        *this, *cb_state, imageMemoryBarrierCount, pImageMemoryBarriers, sourceStageMask, dstStageMask);
}

void Validator::PreCallRecordCmdWaitEvents2KHR(VkCommandBuffer            commandBuffer,
                                               uint32_t                   eventCount,
                                               const VkEvent*             pEvents,
...
void Validator::PreCallRecordCmdWaitEvents2(VkCommandBuffer         commandBuffer,
                                            uint32_t                eventCount,
                                            const VkEvent*          pEvents,
                                            const VkDependencyInfo* pDependencyInfos,
                                            const RecordObject&     record_obj)
...
void Validator::PreCallRecordCmdPipelineBarrier(VkCommandBuffer              commandBuffer,
...
void Validator::PreCallRecordCmdPipelineBarrier2KHR(VkCommandBuffer            commandBuffer,
...
void Validator::PreCallRecordCmdPipelineBarrier2(VkCommandBuffer         commandBuffer,
                                                 ...
                                                 const RecordObject&     record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    TransitionImageLayouts(
        *this, *cb_state, pDependencyInfo->imageMemoryBarrierCount, pDependencyInfo->pImageMemoryBarriers);
}
} // namespace gpuav
