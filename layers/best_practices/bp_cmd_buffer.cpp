...
void BestPractices::CommandBufferCreated(vvl::CommandBuffer& cb_state) {
    cb_state.SetSubState(container_type, std::make_unique<bp_state::CommandBufferSubState>(*this, cb_state));
}
