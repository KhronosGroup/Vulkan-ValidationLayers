...
const char* VK_LAYER_GPUAV_ARRAY_OOB = "gpuav_array_oob";
...
void ProcessConfigAndEnvSettings(ConfigAndEnvSettings* settings_data) {
    ...
    if (!shader_instrumentation_enabled) {
        ...
        if (vkuHasLayerSetting(layer_setting_set, VK_LAYER_GPUAV_ARRAY_OOB)) {
            vkuGetLayerSettingValue(layer_setting_set, VK_LAYER_GPUAV_ARRAY_OOB,
