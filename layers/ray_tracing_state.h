...
class ACCELERATION_STRUCTURE_STATE : public BINDABLE_OLD {
  public:
    ACCELERATION_STRUCTURE_STATE(VkDevice device, VkAccelerationStructureNV as, const VkAccelerationStructureCreateInfoNV *ci)
        : BINDABLE_OLD(as, kVulkanObjectTypeAccelerationStructureNV, false, false, false, 0),
          create_infoNV(ci),
        ...
        resource_size_ = memory_requirements.size;
    }
