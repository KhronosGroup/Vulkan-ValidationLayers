...
GetSubpassDepthStencilAttachmentIndex(const vku::safe_VkPipelineDepthStencilStateCreateInfo* pipe_ds_ci,
...
class Framebuffer : public StateObject {
  public:
    ...
    Framebuffer(VkFramebuffer handle,
