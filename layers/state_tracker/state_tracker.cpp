...
bool DeviceState::PreCallValidateCreateGraphicsPipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t count,
    ...
    for (uint32_t i = 0; i < count; i++) {
        ...
        // NOTE: there used to be some minimal checking here which could cause skip to be true which can no longer
        // be done without causing core validation to be skipped.
