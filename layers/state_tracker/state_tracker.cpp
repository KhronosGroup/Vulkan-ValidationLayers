...
ValidationStateTracker::~ValidationStateTracker()
{
    DestroyObjectMaps();
}

// NOTE:  Beware the lifespan of the rp_begin when holding  the return.  If the rp_begin isn't a "safe" copy,
// "IMAGELESS"
                                                                         ...
                                                                         const vvl::Framebuffer&      fb_state)
{
    ...
    if (fb_state.create_info.flags & VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT)
    {
        const auto* framebuffer_attachments =
            vku::FindStructInPNextChain<VkRenderPassAttachmentBeginInfo>(rp_begin.pNext);
...
std::vector<ImageViewPointer>
GetAttachmentViewsImpl(const VkRenderPassBeginInfo& rp_begin, const vvl::Framebuffer& fb_state, const Get& get_fn)
{
...
std::vector<std::shared_ptr<const vvl::ImageView>>
ValidationStateTracker::GetAttachmentViews(const VkRenderPassBeginInfo& rp_begin,
    ...
    const RecordObject&                       record_obj)
{
    ...
    auto     ahb_format_props2 =
        vku::FindStructInPNextChain<VkAndroidHardwareBufferFormatProperties2ANDROID>(pProperties->pNext);
    ...
    else
    {
        auto ahb_format_props =
            vku::FindStructInPNextChain<VkAndroidHardwareBufferFormatPropertiesANDROID>(pProperties->pNext);
        if (ahb_format_props)
        {
            external_format = ahb_format_props->externalFormat;
            ahb_ext_formats_map.insert(external_format,
    ...
    if (enabled_features.externalFormatResolve)
    {
        ...
        else
        {
            ...
            VkAndroidHardwareBufferFormatResolvePropertiesANDROID new_ahb_format_resolve_props =
...
VkFormatFeatureFlags2 ValidationStateTracker::GetImageFormatFeatures(VkPhysicalDevice physical_device,
                                                                     ...
                                                                     VkImageTiling    tiling)
{
    ...
    if (has_format_feature2)
    {
        ...
        {
            format_features = (tiling == VK_IMAGE_TILING_LINEAR) ? fmt_props_3.linearTilingFeatures
    ...
    else
    {
        ...
        format_features = (tiling == VK_IMAGE_TILING_LINEAR) ? format_properties.linearTilingFeatures
                                                             : format_properties.optimalTilingFeatures;
    }
    return format_features;
}

std::shared_ptr<vvl::Image> ValidationStateTracker::CreateImageState(VkImage                  handle,
                                                       ...
                                                       const RecordObject&          record_obj)
{
    ...
    {
        format_features = GetImageFormatFeatures(physical_device,
                                                 has_format_feature2,
...
void ValidationStateTracker::PreCallRecordCmdClearDepthStencilImage(VkCommandBuffer                 commandBuffer,
                                                                    VkImage                         image,
                                                                    VkImageLayout                   imageLayout,
                                                        ...
                                                        const RecordObject&     record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Image>(pCopyImageInfo->srcImage),
                                                           ...
                                                           const RecordObject&        record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Image>(pResolveImageInfo->srcImage),
                                                        ...
                                                        const RecordObject&     record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Image>(pBlitImageInfo->srcImage),
...
std::shared_ptr<vvl::Buffer> ValidationStateTracker::CreateBufferState(VkBuffer                  handle,
                                                        ...
                                                        const RecordObject&          record_obj)
{
    ...
    const auto* opaque_capture_address =
        vku::FindStructInPNextChain<VkBufferOpaqueCaptureAddressCreateInfo>(pCreateInfo->pNext);
...
std::shared_ptr<vvl::BufferView>
ValidationStateTracker::CreateBufferViewState(const std::shared_ptr<vvl::Buffer>& buffer,
                                              VkBufferView                        handle,
...
void ValidationStateTracker::PostCallRecordCreateBufferView(VkDevice                      device,
...
ValidationStateTracker::CreateImageViewState(const std::shared_ptr<vvl::Image>&                    image_state,
                                             VkImageView                                           handle,
                                                           ...
                                                           const RecordObject&          record_obj)
{
    ...
    else
    {
        format_features = GetImageFormatFeatures(physical_device,
                                                 ...
                                                 pCreateInfo->format,
                                                 image_state->create_info.tiling);
    }
                                                         ...
                                                         const RecordObject&      record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Buffer>(pCopyBufferInfo->srcBuffer),
                                                        ...
                                                        const RecordObject&          record_obj)
{
    if (auto buffer_state = Get<vvl::Buffer>(buffer))
    {
        ...
        if (buffer_state->deviceAddress != 0)
        {
            ...
            buffer_address_map_.erase_range_or_touch(
                address_range, [buffer_state_raw = buffer_state.get()](auto& buffers) {
                                                                ...
                                                                const RecordObject&             record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Image>(pCopyImageToBufferInfo->srcImage),
                                                                ...
                                                                const RecordObject&             record_obj)
{
    ...
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    cb_state->RecordTransferCmd(record_obj.location.function,
                                Get<vvl::Buffer>(pCopyBufferToImageInfo->srcBuffer),
...
std::shared_ptr<vvl::Queue> ValidationStateTracker::CreateQueue(VkQueue                        handle,
...
void ValidationStateTracker::PostCreateDevice(const VkDeviceCreateInfo* pCreateInfo, const Location& loc)
{
    ...
    else
    {
        ...
        if (dev_ext.vk_ext_descriptor_indexing)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_descriptor_indexing, &descriptor_indexing_prop);
        ...
        if (dev_ext.vk_khr_depth_stencil_resolve)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_khr_depth_stencil_resolve, &depth_stencil_resolve_props);
        ...
        if (dev_ext.vk_khr_timeline_semaphore)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_khr_timeline_semaphore, &timeline_semaphore_props);
        ...
        if (dev_ext.vk_ext_sampler_filter_minmax)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_sampler_filter_minmax, &sampler_filter_minmax_props);
        ...
        if (dev_ext.vk_khr_shader_float_controls)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_khr_shader_float_controls, &float_controls_props);
    ...
    else
    {
        ...
        if (dev_ext.vk_ext_inline_uniform_block)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_inline_uniform_block, &inline_uniform_block_props);
        ...
        if (dev_ext.vk_ext_texel_buffer_alignment)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_texel_buffer_alignment, &texel_buffer_alignment_props);
    ...
    if (dev_ext.vk_feature_version_1_4)
    {
        ...
        GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_feature_version_1_4, &phys_dev_props_core14);
        ...
        GetPhysicalDeviceExtProperties<false>(physical_device, dev_ext.vk_feature_version_1_4, &phys_dev_props_core14);
    }
    else
    {
        if (dev_ext.vk_khr_line_rasterization)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_khr_line_rasterization, &line_rasterization_props);
        ...
        else if (dev_ext.vk_ext_line_rasterization)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_line_rasterization, &line_rasterization_props);
            phys_dev_props_core14.lineSubPixelPrecisionBits = line_rasterization_props.lineSubPixelPrecisionBits;
        }
        ...
        if (dev_ext.vk_ext_vertex_attribute_divisor)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_vertex_attribute_divisor, &vtx_attrib_divisor_props_ext);
        ...
        else if (dev_ext.vk_khr_vertex_attribute_divisor)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_khr_vertex_attribute_divisor, &vtx_attrib_divisor_props_khr);
            phys_dev_props_core14.maxVertexAttribDivisor = vtx_attrib_divisor_props_khr.maxVertexAttribDivisor;
            phys_dev_props_core14.supportsNonZeroFirstInstance =
                vtx_attrib_divisor_props_khr.supportsNonZeroFirstInstance;
        }

        if (dev_ext.vk_khr_push_descriptor)
        {
            VkPhysicalDevicePushDescriptorPropertiesKHR push_descriptor_props = vku::InitStructHelper();
            GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_khr_push_descriptor, &push_descriptor_props);
        ...
        if (dev_ext.vk_khr_maintenance5)
        {
            ...
            GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_khr_maintenance5, &maintenance_5_props);
            ...
            phys_dev_props_core14.nonStrictWideLinesUseParallelogram =
                maintenance_5_props.nonStrictWideLinesUseParallelogram;
        }

        if (dev_ext.vk_khr_maintenance6)
        {
            VkPhysicalDeviceMaintenance6PropertiesKHR maintenance_6_props = vku::InitStructHelper();
            GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_khr_maintenance6, &maintenance_6_props);
        ...
        if (dev_ext.vk_ext_pipeline_robustness)
        {
            ...
            GetPhysicalDeviceExtProperties(
                physical_device, dev_ext.vk_ext_pipeline_robustness, &pipeline_robustness_props);
            phys_dev_props_core14.defaultRobustnessStorageBuffers =
                pipeline_robustness_props.defaultRobustnessStorageBuffers;
            phys_dev_props_core14.defaultRobustnessUniformBuffers =
                pipeline_robustness_props.defaultRobustnessUniformBuffers;
            phys_dev_props_core14.defaultRobustnessVertexInputs =
                pipeline_robustness_props.defaultRobustnessVertexInputs;
        ...
        if (dev_ext.vk_ext_host_image_copy)
        {
            ...
            GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_ext_host_image_copy, &host_image_copy_props);
            ...
            GetPhysicalDeviceExtProperties<false>(
                physical_device, dev_ext.vk_ext_host_image_copy, &host_image_copy_props);
            ...
            phys_dev_props_core14.pCopyDstLayouts    = host_imape_copy_props_copy_dst_layouts.data();
            std::memcpy(phys_dev_props_core14.optimalTilingLayoutUUID,
                        host_image_copy_props.optimalTilingLayoutUUID,
                        sizeof(host_image_copy_props.optimalTilingLayoutUUID));
            phys_dev_props_core14.identicalMemoryTypeRequirements =
                host_image_copy_props.identicalMemoryTypeRequirements;
        }
    }
    ...
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_nv_shading_rate_image, &phys_dev_props->shading_rate_image_props);
    ...
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_transform_feedback, &phys_dev_props->transform_feedback_props);
    GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_nv_ray_tracing, &phys_dev_props->ray_tracing_props_nv);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_ray_tracing_pipeline, &phys_dev_props->ray_tracing_props_khr);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_acceleration_structure, &phys_dev_props->acc_structure_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_fragment_density_map, &phys_dev_props->fragment_density_map_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_fragment_density_map2, &phys_dev_props->fragment_density_map2_props);
    GetPhysicalDeviceExtProperties(physical_device,
                                   dev_ext.vk_qcom_fragment_density_map_offset,
                                   &phys_dev_props->fragment_density_map_offset_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_performance_query, &phys_dev_props->performance_query_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_sample_locations, &phys_dev_props->sample_locations_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_custom_border_color, &phys_dev_props->custom_border_color_props);
    GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_khr_multiview, &phys_dev_props->multiview_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_portability_subset, &phys_dev_props->portability_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_fragment_shading_rate, &phys_dev_props->fragment_shading_rate_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_provoking_vertex, &phys_dev_props->provoking_vertex_props);
    GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_ext_multi_draw, &phys_dev_props->multi_draw_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_discard_rectangles, &phys_dev_props->discard_rectangle_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_blend_operation_advanced, &phys_dev_props->blend_operation_advanced_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_conservative_rasterization, &phys_dev_props->conservative_rasterization_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_qcom_image_processing, &phys_dev_props->image_processing_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_mesa_image_alignment_control, &phys_dev_props->image_alignment_control_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_nested_command_buffer, &phys_dev_props->nested_command_buffer_props);

    GetPhysicalDeviceExtProperties(physical_device, dev_ext.vk_khr_maintenance7, &phys_dev_props->maintenance7_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_descriptor_buffer, &phys_dev_props->descriptor_buffer_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_descriptor_buffer, &phys_dev_props->descriptor_buffer_density_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_device_generated_commands, &phys_dev_props->device_generated_commands_props);

    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_map_memory_placed, &phys_dev_props->map_memory_placed_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_pipeline_binary, &phys_dev_props->pipeline_binary_props);
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_khr_compute_shader_derivatives, &phys_dev_props->compute_shader_derivatives_props);
    ...
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_ext_extended_dynamic_state3, &phys_dev_props->extended_dynamic_state3_props);

#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    VkPhysicalDeviceExternalFormatResolvePropertiesANDROID android_format_resolve_props;
    GetPhysicalDeviceExtProperties(
        physical_device, dev_ext.vk_android_external_format_resolve, &android_format_resolve_props);
    ...
    if (IsExtEnabled(dev_ext.vk_nv_cooperative_matrix))
    {
        ...
        DispatchGetPhysicalDeviceCooperativeMatrixPropertiesNV(
            physical_device, &num_cooperative_matrix_properties_nv, NULL);
    ...
    if (IsExtEnabled(dev_ext.vk_khr_cooperative_matrix))
    {
        ...
        DispatchGetPhysicalDeviceCooperativeMatrixPropertiesKHR(
            physical_device, &num_cooperative_matrix_properties_khr, NULL);
    ...
    if (pCreateInfo->pQueueCreateInfos != nullptr)
    {
        ...
        DispatchGetPhysicalDeviceQueueFamilyProperties(
        ...
        for (uint32_t i = 0; i < pCreateInfo->queueCreateInfoCount; ++i)
        {
            ...
            device_queue_info_list.emplace_back(DeviceQueueInfo{
    ...
    if (IsExtEnabled(dev_ext.vk_khr_performance_query))
    {
        ...
        for (uint32_t i = 0; i < queue_family_count; ++i)
        {
            ...
            DispatchEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(
                physical_device, i, &counterCount, nullptr, nullptr);
            ...
            DispatchEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(
                physical_device, i, &counterCount, queue_family_counters->counters.data(), nullptr);
...
void ValidationStateTracker::PreCallRecordQueueSubmit(
    VkQueue queue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence, const RecordObject& record_obj)
{
    ...
    for (uint32_t submit_i = 0; submit_i < submitCount; submit_i++)
    {
        ...
        for (uint32_t i = 0; i < submit->waitSemaphoreCount; ++i)
        {
            ...
            uint64_t value{ 0 };
            if (wait_semaphore->type == VK_SEMAPHORE_TYPE_TIMELINE && timeline_info &&
                timeline_info->pWaitSemaphoreValues && i < timeline_info->waitSemaphoreValueCount)
            {
        ...
        for (uint32_t i = 0; i < submit->signalSemaphoreCount; ++i)
        {
            ...
            uint64_t value{ 0 };
            if (signal_semaphore->type == VK_SEMAPHORE_TYPE_TIMELINE && timeline_info &&
                timeline_info->pSignalSemaphoreValues && i < timeline_info->signalSemaphoreValueCount)
            {
...
void ValidationStateTracker::PostCallRecordQueueSubmit(
    VkQueue queue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence, const RecordObject& record_obj)
{
    if (record_obj.result != VK_SUCCESS)
        return;
...
void ValidationStateTracker::PreCallRecordQueueSubmit2(
    VkQueue queue, uint32_t submitCount, const VkSubmitInfo2* pSubmits, VkFence fence, const RecordObject& record_obj)
{
    ...
    for (uint32_t submit_i = 0; submit_i < submitCount; submit_i++)
    {
        ...
        for (const VkCommandBufferSubmitInfo& cb_info :
             vvl::make_span(submit.pCommandBufferInfos, submit.commandBufferInfoCount))
        {
...
void ValidationStateTracker::PostCallRecordQueueSubmit2KHR(VkQueue                 queue,
                                                           uint32_t                submitCount,
                                                           const VkSubmitInfo2KHR* pSubmits,
                                                           VkFence                 fence,
                                                           const RecordObject&     record_obj)
...
void ValidationStateTracker::PostCallRecordQueueSubmit2(
    VkQueue queue, uint32_t submitCount, const VkSubmitInfo2* pSubmits, VkFence fence, const RecordObject& record_obj)
{
    if (record_obj.result != VK_SUCCESS)
        return;
                                                          ...
                                                          const RecordObject&          record_obj)
{
    ...
    Add(CreateDeviceMemoryState(*pMemory,
                                pAllocateInfo,
                                fake_address,
                                memory_type,
                                memory_heap,
    ...
    for (uint32_t bind_idx = 0; bind_idx < bindInfoCount; ++bind_idx)
    {
        ...
        for (uint32_t j = 0; j < bind_info.bufferBindCount; j++)
        {
            for (uint32_t k = 0; k < bind_info.pBufferBinds[j].bindCount; k++)
            {
                ...
                {
                    buffer_state->BindMemory(buffer_state.get(),
                                             mem_state,
                                             sparse_binding.memoryOffset,
                                             sparse_binding.resourceOffset,
                                             sparse_binding.size);
                }
            }
        }
        for (uint32_t j = 0; j < bind_info.imageOpaqueBindCount; j++)
        {
            for (uint32_t k = 0; k < bind_info.pImageOpaqueBinds[j].bindCount; k++)
            {
                ...
                if (auto image_state = Get<vvl::Image>(bind_info.pImageOpaqueBinds[j].image))
                {
                    ...
                    image_state->BindMemory(image_state.get(),
                                            mem_state,
                                            sparse_binding.memoryOffset,
                                            sparse_binding.resourceOffset,
                                            sparse_binding.size);
        ...
        for (uint32_t j = 0; j < bind_info.imageBindCount; j++)
        {
            for (uint32_t k = 0; k < bind_info.pImageBinds[j].bindCount; k++)
            {
                ...
                // TODO: This size is broken for non-opaque bindings, need to update to comprehend full sparse binding
                // data
                VkDeviceSize size =
                    sparse_binding.extent.depth * sparse_binding.extent.height * sparse_binding.extent.width * 4;
...
void ValidationStateTracker::PostCallRecordQueueBindSparse(VkQueue                 queue,
                                                           uint32_t                bindInfoCount,
                                                           const VkBindSparseInfo* pBindInfo,
                                                           VkFence                 fence,
                                                           const RecordObject&     record_obj)
...
void ValidationStateTracker::RecordImportSemaphoreState(VkSemaphore                           semaphore,
...
void ValidationStateTracker::PreCallRecordSignalSemaphoreKHR(VkDevice                     device,
                                                             const VkSemaphoreSignalInfo* pSignalInfo,
                                                             const RecordObject&          record_obj)
{
                                                       ...
                                                       VkQueue                  queue)
{
    if (Get<vvl::Queue>(queue) == nullptr)
    {
        ...
        Add(CreateQueue(
            queue, queue_family_index, queue_index, flags, queue_family_properties_list[queue_family_index]));
    }
}

void ValidationStateTracker::PostCallRecordGetDeviceQueue(
...
void ValidationStateTracker::UpdateBindBufferMemoryState(const VkBindBufferMemoryInfo& bind_info)
{
    ...
    {
        buffer_state->BindMemory(
            buffer_state.get(), mem_state, bind_info.memoryOffset, 0u, buffer_state->requirements.size);
    }
}

void ValidationStateTracker::PostCallRecordBindBufferMemory(
...
void ValidationStateTracker::PostCallRecordBindBufferMemory2(VkDevice                      device,
                                                             uint32_t                      bindInfoCount,
...
void ValidationStateTracker::PostCallRecordBindBufferMemory2KHR(VkDevice                      device,
                                                                uint32_t                      bindInfoCount,
                                                                const VkBindBufferMemoryInfo* pBindInfos,
                                                                const RecordObject&           record_obj)
{
...
void ValidationStateTracker::RecordGetImageMemoryRequirementsState(VkImage                               image,
...
void ValidationStateTracker::PostCallRecordGetImageMemoryRequirements(VkDevice              device,
                                                                      VkImage               image,
...
void ValidationStateTracker::PostCallRecordGetImageMemoryRequirements2(VkDevice                              device,
                                                                       const VkImageMemoryRequirementsInfo2* pInfo,
    ...
    const RecordObject&                         record_obj)
{
    PostCallRecordGetImageSparseMemoryRequirements2(
        device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements, record_obj);
}

void ValidationStateTracker::PreCallRecordDestroyShaderModule(VkDevice                     device,
...
void ValidationStateTracker::PreCallRecordDestroyShaderEXT(VkDevice                     device,
                                                           VkShaderEXT                  shader,
                                                           const VkAllocationCallbacks* pAllocator,
                                                           const RecordObject&          record_obj)
{
...
void ValidationStateTracker::PostCallRecordCmdBindShadersEXT(VkCommandBuffer              commandBuffer,
                                                             uint32_t                     stageCount,
...
void ValidationStateTracker::PreCallRecordDestroyPipelineLayout(VkDevice                     device,
...
void ValidationStateTracker::PreCallRecordDestroyDescriptorSetLayout(VkDevice                     device,
...
void ValidationStateTracker::PreCallRecordDestroyDescriptorPool(VkDevice                     device,
...
std::shared_ptr<vvl::CommandPool>
ValidationStateTracker::CreateCommandPoolState(VkCommandPool handle, const VkCommandPoolCreateInfo* create_info)
{
...
void ValidationStateTracker::PostCallRecordCreateCommandPool(VkDevice                       device,
                                                           ...
                                                           const RecordObject&          record_obj)
{
    ...
    if (pCreateInfo->queryType == VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR)
    {
        ...
        DispatchGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(
            physical_device_state->VkHandle(), perf, &n_perf_pass);
    }
    ...
    Add(std::make_shared<vvl::QueryPool>(
        *pQueryPool,
        pCreateInfo,
        index_count,
        perf_queue_family_index,
        n_perf_pass,
        has_cb,
        has_rb,
        video_profile_cache_.Get(physical_device,
                                 vku::FindStructInPNextChain<VkVideoProfileInfoKHR>(pCreateInfo->pNext)),
        video_encode_feedback_flags));
}

void ValidationStateTracker::PreCallRecordDestroyCommandPool(VkDevice                     device,
                                                             VkCommandPool                commandPool,
                                                             const VkAllocationCallbacks* pAllocator,
                                                             const RecordObject&          record_obj)
{
...
void ValidationStateTracker::PreCallRecordDestroyFramebuffer(VkDevice                     device,
...
std::shared_ptr<vvl::PipelineCache>
ValidationStateTracker::CreatePipelineCacheState(VkPipelineCache                  handle,
                                                 const VkPipelineCacheCreateInfo* create_info) const
{
    return std::make_shared<vvl::PipelineCache>(handle, create_info);
}

void ValidationStateTracker::PostCallRecordCreatePipelineCache(VkDevice                         device,
...
void ValidationStateTracker::PreCallRecordDestroyPipelineCache(VkDevice                     device,
...
{
    return std::make_shared<vvl::Pipeline>(
        *this, create_info, std::move(pipeline_cache), std::move(render_pass), std::move(layout), stateless_data);
}
    ...
    chassis::CreateGraphicsPipelines&   chassis_state) const
{
    ...
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        else if (enabled_features.dynamicRendering)
        {
            ...
            const bool has_fragment_output_state = vvl::Pipeline::ContainsSubState(
                this, create_info, VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT);
            render_pass = std::make_shared<vvl::RenderPass>(dynamic_rendering,
                                                            rasterization_enabled && has_fragment_output_state);
        }
        else
        {
            const bool is_graphics_lib =
                GetGraphicsLibType(create_info) != static_cast<VkGraphicsPipelineLibraryFlagsEXT>(0);
            const bool has_link_info =
                vku::FindStructInPNextChain<VkPipelineLibraryCreateInfoKHR>(create_info.pNext) != nullptr;
        ...
        pipeline_states.push_back(CreateGraphicsPipelineState(&create_info,
                                                              pipeline_cache,
                                                              std::move(render_pass),
                                                              std::move(layout_state),
                                                              chassis_state.stateless_data));
    }
    return skip;
}

void ValidationStateTracker::PostCallRecordCreateGraphicsPipelines(VkDevice                            device,
                                                                   VkPipelineCache                     pipelineCache,
                                                                   uint32_t                            count,
                                                                   const VkGraphicsPipelineCreateInfo* pCreateInfos,
                                                                   const VkAllocationCallbacks*        pAllocator,
...
ValidationStateTracker::CreateComputePipelineState(const VkComputePipelineCreateInfo*           create_info,
                                                   std::shared_ptr<const vvl::PipelineCache>    pipeline_cache,
                                                   std::shared_ptr<const vvl::PipelineLayout>&& layout,
                                                   spirv::StatelessData*                        stateless_data) const
{
    return std::make_shared<vvl::Pipeline>(
        *this, create_info, std::move(pipeline_cache), std::move(layout), stateless_data);
}

bool ValidationStateTracker::PreCallValidateCreateComputePipelines(VkDevice                           device,
                                                                   VkPipelineCache                    pipelineCache,
                                                                   uint32_t                           count,
                                                                   ...
                                                                   chassis::CreateComputePipelines& chassis_state) const
{
    ...
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        pipeline_states.push_back(CreateComputePipelineState(&pCreateInfos[i],
                                                             pipeline_cache,
                                                             Get<vvl::PipelineLayout>(pCreateInfos[i].layout),
                                                             &chassis_state.stateless_data));
    }
    return false;
}

void ValidationStateTracker::PostCallRecordCreateComputePipelines(VkDevice                           device,
                                                                  VkPipelineCache                    pipelineCache,
                                                                  uint32_t                           count,
                                                                  const VkComputePipelineCreateInfo* pCreateInfos,
                                                                  const VkAllocationCallbacks*       pAllocator,
...
std::shared_ptr<vvl::Pipeline>
ValidationStateTracker::CreateRayTracingPipelineState(const VkRayTracingPipelineCreateInfoNV*      create_info,
                                                      std::shared_ptr<const vvl::PipelineCache>    pipeline_cache,
                                                      std::shared_ptr<const vvl::PipelineLayout>&& layout,
                                                      spirv::StatelessData*                        stateless_data) const
{
    ...
    chassis::CreateRayTracingPipelinesNV&   chassis_state) const
{
    ...
    {
        // Create and initialize internal tracking data structure
        pipeline_states.push_back(CreateRayTracingPipelineState(
            &pCreateInfos[i], pipeline_cache, Get<vvl::PipelineLayout>(pCreateInfos[i].layout), nullptr));
    }
    return false;
}
...
// TODO - Add tests and pass down StatelessData
std::shared_ptr<vvl::Pipeline>
ValidationStateTracker::CreateRayTracingPipelineState(const VkRayTracingPipelineCreateInfoKHR*     create_info,
                                                      std::shared_ptr<const vvl::PipelineCache>    pipeline_cache,
                                                      std::shared_ptr<const vvl::PipelineLayout>&& layout,
                                                      spirv::StatelessData*                        stateless_data) const
{
    ...
    std::shared_ptr<chassis::CreateRayTracingPipelinesKHR> chassis_state)
{
    ...
    else
    {
        ...
        cleanup_fn.emplace_back(
            [this, chassis_state, pipeline_states](const std::vector<VkPipeline>& pipelines) mutable {
...
std::shared_ptr<vvl::Sampler> ValidationStateTracker::CreateSamplerState(VkSampler                  handle,
...
void ValidationStateTracker::PostCallRecordGetDescriptorSetLayoutSizeEXT(VkDevice              device,
...
void ValidationStateTracker::PostCallRecordCreatePipelineLayout(VkDevice                          device,
...
ValidationStateTracker::CreateDescriptorPoolState(VkDescriptorPool                  handle,
...
ValidationStateTracker::CreateDescriptorSet(VkDescriptorSet                                        handle,
...
void ValidationStateTracker::PostCallRecordCreateDescriptorPool(VkDevice                          device,
...
void ValidationStateTracker::PostCallRecordAllocateDescriptorSets(VkDevice                           device,
                                                                  const VkDescriptorSetAllocateInfo* pAllocateInfo,
                                                                  VkDescriptorSet*                   pDescriptorSets,
                                                                  const RecordObject&                record_obj,
...
void ValidationStateTracker::PerformUpdateDescriptorSets(uint32_t                    write_count,
...
void ValidationStateTracker::PreCallRecordUpdateDescriptorSets(VkDevice                    device,
...
void ValidationStateTracker::PostCallRecordAllocateCommandBuffers(VkDevice                           device,
                                                          ...
                                                          const RecordObject& record_obj)
{
    ...
    if (VK_PIPELINE_BIND_POINT_GRAPHICS == pipelineBindPoint)
    {
        ...
        // If rasterization disabled (no viewport/scissors used), or the actual number of viewports/scissors is dynamic
        // (unknown at this time), then these are set to 0 to disable this checking.
        ...
        cb_state->pipelineStaticScissorCount =
            (has_dynamic_scissor_count || !viewport_state) ? 0 : viewport_state->scissorCount;
    ...
    if (enabled_features.variableMultisampleRate == VK_FALSE)
    {
        if (const auto* multisample_state = pipe_state->MultisampleState(); multisample_state)
        {
            if (const auto& render_pass = cb_state->activeRenderPass; render_pass)
            {
                ...
                // pMultisampleState->rasterizationSamples. To check that, record
...
void ValidationStateTracker::PostCallRecordCmdSetExclusiveScissorNV(VkCommandBuffer     commandBuffer,
                                                                          ...
                                                                          const RecordObject& record_obj)
{
    ...
    for (size_t i = 0; i < exclusiveScissorCount; ++i)
    {
        cb_state->dynamic_state_value.exclusive_scissor_enables[firstExclusiveScissor + i] =
            pExclusiveScissorEnables[i];
    }
}
...
std::shared_ptr<vvl::AccelerationStructureNV>
ValidationStateTracker::CreateAccelerationStructureState(VkAccelerationStructureNV                  handle,
...
ValidationStateTracker::CreateAccelerationStructureState(VkAccelerationStructureKHR                  handle,
...
void ValidationStateTracker::RecordDeviceAccelerationStructureBuildInfo(
    vvl::CommandBuffer& cb_state, const VkAccelerationStructureBuildGeometryInfoKHR& info)
{
    ...
    const RecordObject&                                record_obj)
{
    ...
    for (uint32_t i = 0; i < infoCount; i++)
    {
        ...
        // Issue https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/6461
        // showed that it is incorrect to try to add buffers obtained through a call to GetBuffersByAddress as children
        // to a command buffer
    }
    cb_state->has_build_as_cmd = true;
}
    ...
    const RecordObject&                            record_obj)
{
    ...
    for (uint32_t i = 0; i < bindInfoCount; i++)
    {
        ...
        if (auto as_state = Get<vvl::AccelerationStructureNV>(info.accelerationStructure))
        {
            ...
            {
                as_state->BindMemory(
                    as_state.get(), mem_state, info.memoryOffset, 0u, as_state->memory_requirements.size);
            }
            ...
            if (enabled[gpu_validation])
            {
                DispatchGetAccelerationStructureHandleNV(
                    device, info.accelerationStructure, 8, &as_state->opaque_handle);
            }
        }
    }
}

void ValidationStateTracker::PostCallRecordCmdBuildAccelerationStructureNV(VkCommandBuffer commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetViewportWScalingNV(VkCommandBuffer             commandBuffer,
                                                                    uint32_t                    firstViewport,
                                                                    uint32_t                    viewportCount,
...
void ValidationStateTracker::PostCallRecordCmdSetLineStipple(VkCommandBuffer     commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetLineStippleKHR(VkCommandBuffer     commandBuffer,
                                                                uint32_t            lineStippleFactor,
                                                                uint16_t            lineStipplePattern,
                                                                const RecordObject& record_obj)
{
...
void ValidationStateTracker::PostCallRecordCmdSetDepthBias2EXT(VkCommandBuffer           commandBuffer,
                                                               ...
                                                               const RecordObject&       record_obj)
{
    PostCallRecordCmdSetDepthBias(commandBuffer,
                                  pDepthBiasInfo->depthBiasConstantFactor,
                                                                ...
                                                                const RecordObject&    record_obj)
{
    ...
    cb_state->UpdateLastBoundDescriptorSets(pipelineBindPoint,
                                            *pipeline_layout,
...
void ValidationStateTracker::PreCallRecordCmdBindDescriptorSets2(
    VkCommandBuffer                 commandBuffer,
    ...
    const RecordObject&             record_obj)
{
    ...
    {
        cb_state->UpdateLastBoundDescriptorSets(VK_PIPELINE_BIND_POINT_GRAPHICS,
                                                *pipeline_layout,
                                                record_obj.location.function,
    ...
    {
        cb_state->UpdateLastBoundDescriptorSets(VK_PIPELINE_BIND_POINT_COMPUTE,
                                                *pipeline_layout,
                                                record_obj.location.function,
                                                pBindDescriptorSetsInfo->firstSet,
                                                pBindDescriptorSetsInfo->descriptorSetCount,
    ...
    {
        cb_state->UpdateLastBoundDescriptorSets(VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR,
                                                *pipeline_layout,
                                                record_obj.location.function,
                                                pBindDescriptorSetsInfo->firstSet,
                                                pBindDescriptorSetsInfo->descriptorSetCount,
...
void ValidationStateTracker::PreCallRecordCmdBindDescriptorSets2KHR(
    VkCommandBuffer                    commandBuffer,
...
void ValidationStateTracker::PreCallRecordCmdPushDescriptorSet(VkCommandBuffer             commandBuffer,
                                                               VkPipelineBindPoint         pipelineBindPoint,
                                                               VkPipelineLayout            layout,
                                                               uint32_t                    set,
                                                               uint32_t                    descriptorWriteCount,
                                                               ...
                                                               const RecordObject&         record_obj)
{
    ...
    cb_state->PushDescriptorSetState(pipelineBindPoint,
                                     *pipeline_layout,
                                     record_obj.location.function,
                                     set,
                                                                ...
                                                                const RecordObject&            record_obj)
{
    ...
    {
        cb_state->PushDescriptorSetState(VK_PIPELINE_BIND_POINT_GRAPHICS,
                                         *pipeline_layout,
                                         record_obj.location.function,
    ...
    {
        cb_state->PushDescriptorSetState(VK_PIPELINE_BIND_POINT_COMPUTE,
                                         *pipeline_layout,
                                         record_obj.location.function,
                                         pPushDescriptorSetInfo->set,
                                         pPushDescriptorSetInfo->descriptorWriteCount,
    ...
    {
        cb_state->PushDescriptorSetState(VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR,
                                         *pipeline_layout,
                                         record_obj.location.function,
                                         pPushDescriptorSetInfo->set,
                                         pPushDescriptorSetInfo->descriptorWriteCount,
...
void ValidationStateTracker::PreCallRecordCmdPushDescriptorSet2KHR(
    VkCommandBuffer                   commandBuffer,
                                                                           ...
                                                                           const RecordObject& record_obj)
{
    ...
    cb_state->UpdateLastBoundDescriptorBuffers(
        pipelineBindPoint, *pipeline_layout, firstSet, setCount, pBufferIndices, pOffsets);
}
    ...
    const RecordObject&                        record_obj)
{
    ...
    {
        cb_state->UpdateLastBoundDescriptorBuffers(VK_PIPELINE_BIND_POINT_GRAPHICS,
                                                   *pipeline_layout,
    ...
    {
        cb_state->UpdateLastBoundDescriptorBuffers(VK_PIPELINE_BIND_POINT_COMPUTE,
                                                   *pipeline_layout,
                                                   pSetDescriptorBufferOffsetsInfo->firstSet,
                                                   pSetDescriptorBufferOffsetsInfo->setCount,
                                                   pSetDescriptorBufferOffsetsInfo->pBufferIndices,
    ...
    {
        cb_state->UpdateLastBoundDescriptorBuffers(VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR,
                                                   *pipeline_layout,
                                                   pSetDescriptorBufferOffsetsInfo->firstSet,
                                                   pSetDescriptorBufferOffsetsInfo->setCount,
                                                   pSetDescriptorBufferOffsetsInfo->pBufferIndices,
...
void ValidationStateTracker::PostCallRecordCmdPushConstants2(VkCommandBuffer            commandBuffer,
                                                             ...
                                                             const RecordObject&        record_obj)
{
    PostCallRecordCmdPushConstants(commandBuffer,
...
void ValidationStateTracker::PreCallRecordCmdBindIndexBuffer2(VkCommandBuffer     commandBuffer,
                                                              VkBuffer            buffer,
                                                              VkDeviceSize        offset,
                                                              VkDeviceSize        size,
                                                              VkIndexType         indexType,
...
void ValidationStateTracker::PreCallRecordCmdBindIndexBuffer2KHR(VkCommandBuffer     commandBuffer,
                                                                 VkBuffer            buffer,
                                                                 VkDeviceSize        offset,
                                                                 VkDeviceSize        size,
                                                                 VkIndexType         indexType,
                                                               ...
                                                               const RecordObject& record_obj)
{
    ...
    for (uint32_t i = 0; i < bindingCount; ++i)
    {
        ...
        vvl::VertexBufferBinding& vertex_buffer_binding =
            cb_state->current_vertex_buffer_binding_info[i + firstBinding];
...
void ValidationStateTracker::PreCallRecordCmdSetEvent2KHR(VkCommandBuffer            commandBuffer,
                                                          VkEvent                    event,
...
void ValidationStateTracker::PreCallRecordCmdWaitEvents(VkCommandBuffer              commandBuffer,
                                                        uint32_t                     eventCount,
                                                        ...
                                                        const RecordObject&          record_obj)
{
    ...
    cb_state->RecordBarriers(memoryBarrierCount,
                             pMemoryBarriers,
...
void ValidationStateTracker::PreCallRecordCmdWaitEvents2KHR(VkCommandBuffer            commandBuffer,
                                                            uint32_t                   eventCount,
                                                            const VkEvent*             pEvents,
...
void ValidationStateTracker::PostCallRecordCmdPipelineBarrier(VkCommandBuffer              commandBuffer,
...
void ValidationStateTracker::PostCallRecordCreateVideoSessionKHR(VkDevice                           device,
...
void ValidationStateTracker::PreCallRecordDestroyVideoSessionKHR(VkDevice                     device,
                                                                 VkVideoSessionKHR            videoSession,
                                                                 const VkAllocationCallbacks* pAllocator,
                                                                 const RecordObject&          record_obj)
{
    ...
    const RecordObject&                          record_obj)
{
    ...
    Add(std::make_shared<vvl::VideoSessionParameters>(
        *pVideoSessionParameters,
        pCreateInfo,
        Get<vvl::VideoSession>(pCreateInfo->videoSession),
...
void ValidationStateTracker::PostCallRecordCreateFramebuffer(VkDevice                       device,
                                                             ...
                                                             const RecordObject&            record_obj)
{
    ...
    Add(std::make_shared<vvl::Framebuffer>(
        *pFramebuffer, pCreateInfo, Get<vvl::RenderPass>(pCreateInfo->renderPass), std::move(views)));
}

void ValidationStateTracker::PostCallRecordCreateRenderPass(VkDevice                      device,
...
void ValidationStateTracker::PostCallRecordCreateRenderPass2KHR(VkDevice                       device,
...
void ValidationStateTracker::PostCallRecordCreateRenderPass2(VkDevice                       device,
                                                             const VkRenderPassCreateInfo2* pCreateInfo,
                                                             const VkAllocationCallbacks*   pAllocator,
                                                             VkRenderPass*                  pRenderPass,
                                                             const RecordObject&            record_obj)
...
void ValidationStateTracker::PostCallRecordCmdBeginTransformFeedbackEXT(VkCommandBuffer     commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdEndTransformFeedbackEXT(VkCommandBuffer     commandBuffer,
                                                                      uint32_t            firstCounterBuffer,
                                                                      uint32_t            counterBufferCount,
                                                                      const VkBuffer*     pCounterBuffers,
                                                                      const VkDeviceSize* pCounterBufferOffsets,
...
void ValidationStateTracker::PostCallRecordMapMemory2(VkDevice               device,
...
void ValidationStateTracker::PreCallRecordUnmapMemory(VkDevice            device,
                                                      VkDeviceMemory      mem,
                                                      const RecordObject& record_obj)
{
    if (auto mem_info = Get<vvl::DeviceMemory>(mem))
...
void ValidationStateTracker::PreCallRecordUnmapMemory2(VkDevice                 device,
...
void ValidationStateTracker::PreCallRecordUnmapMemory2KHR(VkDevice                    device,
    ...
    else
    {
        ...
        if (auto mem_info = Get<vvl::DeviceMemory>(bind_info.memory))
        {
            ...
            image_state->BindMemory(
                ...
                plane_index,
                image_state->requirements[static_cast<decltype(image_state->requirements)::size_type>(plane_index)]
                    .size);
        }
    }
}

void ValidationStateTracker::PostCallRecordBindImageMemory(
    VkDevice device, VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset, const RecordObject& record_obj)
{
    if (VK_SUCCESS != record_obj.result)
        return;
...
void ValidationStateTracker::PostCallRecordBindImageMemory2KHR(VkDevice                     device,
                                                               uint32_t                     bindInfoCount,
                                                               const VkBindImageMemoryInfo* pBindInfos,
                                                               const RecordObject&          record_obj)
{
    ...
    VkDevice device, const VkImportSemaphoreFdInfoKHR* pImportSemaphoreFdInfo, const RecordObject& record_obj)
{
    if (VK_SUCCESS != record_obj.result)
        return;
    RecordImportSemaphoreState(
        pImportSemaphoreFdInfo->semaphore, pImportSemaphoreFdInfo->handleType, pImportSemaphoreFdInfo->flags);
}
...
void ValidationStateTracker::PostCallRecordGetSemaphoreFdKHR(VkDevice                       device,
...
void ValidationStateTracker::PostCallRecordImportFenceFdKHR(VkDevice                      device,
...
void ValidationStateTracker::RecordGetExternalFenceState(VkFence                           fence,
                                                         VkExternalFenceHandleTypeFlagBits handle_type,
                                                         const Location&                   loc)
{
    if (auto fence_state = Get<vvl::Fence>(fence))
...
void ValidationStateTracker::RecordCreateSwapchainState(VkResult                        result,
        ...
        // Initialize swapchain image state
        {
            ...
            for (uint32_t i = 0; i < swapchain_image_count; ++i)
            {
                auto format_features =
                    GetImageFormatFeatures(physical_device,
                                           has_format_feature2,
                                           IsExtEnabled(device_extensions.vk_ext_image_drm_format_modifier),
                                           device,
                                           swapchain_images[i],
                                           ...
                                           image_ci.tiling);
                auto image_state =
                    CreateImageState(swapchain_images[i], image_ci.ptr(), swapchain->VkHandle(), i, format_features);
...
void ValidationStateTracker::PostCallRecordCreateSwapchainKHR(VkDevice                        device,
                                                              const VkSwapchainCreateInfoKHR* pCreateInfo,
                                                              const VkAllocationCallbacks*    pAllocator,
                                                              VkSwapchainKHR*                 pSwapchain,
                                                              const RecordObject&             record_obj)
{
    ...
    RecordCreateSwapchainState(
        record_obj.result, pCreateInfo, pSwapchain, std::move(surface_state), old_swapchain_state.get());
}

void ValidationStateTracker::PreCallRecordDestroySwapchainKHR(VkDevice                     device,
                                                              VkSwapchainKHR               swapchain,
                                                              const VkAllocationCallbacks* pAllocator,
                                                              const RecordObject&          record_obj)
{
...
void ValidationStateTracker::PostCallRecordCreateDisplayModeKHR(VkPhysicalDevice                  physicalDevice,
                                                           ...
                                                           const RecordObject&     record_obj)
{
    ...
    // VK_ERROR_OUT_OF_HOST_MEMORY or VK_ERROR_OUT_OF_DEVICE_MEMORY. If it does, the implementation must ensure that the
    // state and contents of any resources or synchronization primitives referenced is unaffected by the call or its
    // failure.
    //
    // If vkQueuePresentKHR fails in such a way that the implementation is unable to make that guarantee, the
    // implementation must return VK_ERROR_DEVICE_LOST.
    //
    // However, if the presentation request is rejected by the presentation engine with an error
    // VK_ERROR_OUT_OF_DATE_KHR, VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT, or VK_ERROR_SURFACE_LOST_KHR, the set of
    // queue operations are still considered to be enqueued and thus any semaphore wait operation specified in
    // VkPresentInfoKHR will execute when the corresponding queue operation is complete.
    //
    // NOTE: This is the only queue submit-like call that has its state updated in PostCallRecord(). In part that is
    // because of these non-fatal error cases. Also we need a place to handle the swapchain image bookkeeping, which
    // really should be happening once all the wait semaphores have completed. Since most of the PostCall queue submit
    // race conditions are related to timeline semaphores, and acquire sempaphores are always binary, this seems ok-ish.
    ...
    for (uint32_t i = 0; i < pPresentInfo->swapchainCount; ++i)
    {
        ...
        {
            uint64_t present_id =
                (present_id_info && i < present_id_info->swapchainCount) ? present_id_info->pPresentIds[i] : 0;
...
void ValidationStateTracker::PostCallRecordReleaseSwapchainImagesEXT(
...
void ValidationStateTracker::PostCallRecordCreateSharedSwapchainsKHR(VkDevice                        device,
                                                                     ...
                                                                     const RecordObject&             record_obj)
{
    if (pCreateInfos)
    {
        for (uint32_t i = 0; i < swapchainCount; i++)
        {
            ...
            RecordCreateSwapchainState(record_obj.result,
                                       &pCreateInfos[i],
                                       &pSwapchains[i],
                                                               ...
                                                               const RecordObject& record_obj)
{
    ...
    RecordAcquireNextImageState(
        device, swapchain, timeout, semaphore, fence, pImageIndex, record_obj.location.function);
}

void ValidationStateTracker::PostCallRecordAcquireNextImage2KHR(VkDevice                         device,
                                                                ...
                                                                const RecordObject&              record_obj)
{
    if ((VK_SUCCESS != record_obj.result) && (VK_SUBOPTIMAL_KHR != record_obj.result))
        return;
    RecordAcquireNextImageState(device,
    ...
    const RecordObject&       record_obj)
{
    PostCallRecordGetPhysicalDeviceQueueFamilyProperties2(
        physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties, record_obj);
}
...
{
    Add(std::make_shared<vvl::Surface>(*pSurface));
}
...
void ValidationStateTracker::PostCallRecordCreateIOSSurfaceMVK(VkInstance                       instance,
...
void ValidationStateTracker::PostCallRecordCreateXcbSurfaceKHR(VkInstance                       instance,
...
void ValidationStateTracker::PostCallRecordCreateXlibSurfaceKHR(VkInstance                        instance,
    ...
    const RecordObject&                    record_obj)
{
    ...
    if (pSurfaceInfo->surface)
    {
        ...
        {
            const auto* surface_present_mode =
                vku::FindStructInPNextChain<VkSurfacePresentModeEXT>(pSurfaceInfo->pNext);
            if (surface_present_mode)
            {
                ...
                const bool single_pnext_element =
                    (pSurfaceInfo->pNext == surface_present_mode) && !surface_present_mode->pNext;
                if (single_pnext_element)
                {
                    surface_state->UpdateCapabilitiesCache(
                        physicalDevice, *pSurfaceCapabilities, surface_present_mode->presentMode);
                }
            }
        }
    }
...
void ValidationStateTracker::PostCallRecordGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice    physicalDevice,
                                                                              VkSurfaceKHR        surface,
...
void ValidationStateTracker::PostCallRecordAcquireProfilingLockKHR(VkDevice                             device,
...
void ValidationStateTracker::PreCallRecordCmdPushDescriptorSetWithTemplate(
    VkCommandBuffer            commandBuffer,
    VkDescriptorUpdateTemplate descriptorUpdateTemplate,
    VkPipelineLayout           layout,
    uint32_t                   set,
    ...
    const RecordObject&        record_obj)
{
    ...
    cb_state->PushDescriptorSetState(template_ci.pipelineBindPoint,
                                     *pipeline_layout,
                                     record_obj.location.function,
                                     set,
...
void ValidationStateTracker::PreCallRecordCmdPushDescriptorSetWithTemplateKHR(
    ...
    const RecordObject&        record_obj)
{
    PreCallRecordCmdPushDescriptorSetWithTemplate(
        commandBuffer, descriptorUpdateTemplate, layout, set, pData, record_obj);
}
    ...
    const RecordObject&                        record_obj)
{
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    auto template_state =
        Get<vvl::DescriptorUpdateTemplate>(pPushDescriptorSetWithTemplateInfo->descriptorUpdateTemplate);
    ...
    vvl::DecodedTemplateUpdate decoded_template(
        *this, VK_NULL_HANDLE, template_state.get(), pPushDescriptorSetWithTemplateInfo->pData, dsl->VkHandle());
    cb_state->PushDescriptorSetState(template_ci.pipelineBindPoint,
                                     *pipeline_layout,
                                     record_obj.location.function,
...
void ValidationStateTracker::PostCallRecordCmdEndQueryIndexedEXT(
...
void ValidationStateTracker::PostCallRecordDestroySamplerYcbcrConversion(VkDevice                     device,
...
void ValidationStateTracker::PostCallRecordResetQueryPoolEXT(
    VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, const RecordObject& record_obj)
{
    PostCallRecordResetQueryPool(device, queryPool, firstQuery, queryCount, record_obj);
}

void ValidationStateTracker::PostCallRecordResetQueryPool(
    VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, const RecordObject& record_obj)
{
...
void ValidationStateTracker::PerformUpdateDescriptorSetsWithTemplateKHR(
    VkDescriptorSet descriptorSet, const vvl::DescriptorUpdateTemplate* template_state, const void* pData)
{
    // Translate the templated update into a normal update for validation...
    vvl::DecodedTemplateUpdate decoded_update(*this, descriptorSet, template_state, pData);
    PerformUpdateDescriptorSets(
        static_cast<uint32_t>(decoded_update.desc_writes.size()), decoded_update.desc_writes.data(), 0, NULL);
}
...
void ValidationStateTracker::PostCallRecordCmdDrawMultiIndexedEXT(VkCommandBuffer                  commandBuffer,
                                                                  uint32_t                         drawCount,
...
void ValidationStateTracker::PostCallRecordCmdDispatch(
...
void ValidationStateTracker::PreCallRecordCmdDrawIndexedIndirectCountKHR(VkCommandBuffer     commandBuffer,
                                                                         VkBuffer            buffer,
                                                                         VkDeviceSize        offset,
                                                                         VkBuffer            countBuffer,
                                                                         VkDeviceSize        countBufferOffset,
...
void ValidationStateTracker::PreCallRecordCmdDrawIndexedIndirectCount(VkCommandBuffer     commandBuffer,
                                                                      VkBuffer            buffer,
                                                                      VkDeviceSize        offset,
                                                                      VkBuffer            countBuffer,
                                                                      VkDeviceSize        countBufferOffset,
...
void ValidationStateTracker::PreCallRecordCmdDrawMeshTasksIndirectCountNV(VkCommandBuffer     commandBuffer,
                                                                          VkBuffer            buffer,
                                                                          VkDeviceSize        offset,
                                                                          VkBuffer            countBuffer,
                                                                          VkDeviceSize        countBufferOffset,
...
void ValidationStateTracker::PreCallRecordCmdDrawMeshTasksIndirectCountEXT(VkCommandBuffer     commandBuffer,
                                                                           VkBuffer            buffer,
                                                                           VkDeviceSize        offset,
                                                                           VkBuffer            countBuffer,
                                                                           VkDeviceSize        countBufferOffset,
...
void ValidationStateTracker::PostCallRecordCmdExecuteGeneratedCommandsEXT(
    VkCommandBuffer                   commandBuffer,
...
void ValidationStateTracker::PreCallRecordCreateShaderModule(VkDevice                        device,
                                                             ...
                                                             chassis::CreateShaderModule&    chassis_state)
{
    ...
    if (chassis_state.module_state && chassis_state.stateless_data.has_group_decoration)
    {
        ...
        auto result = optimizer.Run(chassis_state.module_state->words_.data(),
                                    chassis_state.module_state->words_.size(),
                                    &optimized_binary,
        ...
        if (result)
        {
            ...
            // It is really rare this will get here as Group Decorations have been deprecated and before this was added
            // no one ever raised an issue for a bug that would crash the layers that was around for many releases
            chassis_state.module_state = std::make_shared<spirv::Module>(
                optimized_binary.size() * sizeof(uint32_t), optimized_binary.data(), &chassis_state.stateless_data);
        }
    }
}

void ValidationStateTracker::PreCallRecordCreateShadersEXT(VkDevice                     device,
    ...
    for (uint32_t i = 0; i < createInfoCount; ++i)
    {
        ...
        if (pCreateInfos[i].codeType == VK_SHADER_CODE_TYPE_SPIRV_EXT)
        {
            chassis_state.module_states[i] =
                std::make_shared<spirv::Module>(pCreateInfos[i].codeSize,
                                                static_cast<const uint32_t*>(pCreateInfos[i].pCode),
                                                &chassis_state.stateless_data[i]);
        }
    }
}

void ValidationStateTracker::PostCallRecordCreateShaderModule(VkDevice                        device,
                                                              const VkShaderModuleCreateInfo* pCreateInfo,
                                                              const VkAllocationCallbacks*    pAllocator,
                                                              VkShaderModule*                 pShaderModule,
                                                              const RecordObject&             record_obj,
...
void ValidationStateTracker::PostCallRecordCreateShadersEXT(VkDevice                     device,
                                                            uint32_t                     createInfoCount,
                                                            const VkShaderCreateInfoEXT* pCreateInfos,
                                                            const VkAllocationCallbacks* pAllocator,
                                                            VkShaderEXT*                 pShaders,
                                                            ...
                                                            chassis::ShaderObject&       chassis_state)
{
    ...
    for (uint32_t i = 0; i < createInfoCount; ++i)
    {
        ...
        {
            Add(std::make_shared<vvl::ShaderObject>(
                *this, pCreateInfos[i], pShaders[i], chassis_state.module_states[i], createInfoCount, pShaders));
        }
    }
}

void ValidationStateTracker::PostCallRecordCopyAccelerationStructureKHR(VkDevice               device,
                                                                        VkDeferredOperationKHR deferredOperation,
...
void ValidationStateTracker::PostCallRecordCmdCopyAccelerationStructureKHR(
    VkCommandBuffer commandBuffer, const VkCopyAccelerationStructureInfoKHR* pInfo, const RecordObject& record_obj)
{
    auto cb_state = GetWrite<vvl::CommandBuffer>(commandBuffer);
    ASSERT_AND_RETURN(cb_state);
    cb_state->RecordCmd(record_obj.location.function);
...
void ValidationStateTracker::PostCallRecordCmdBindVertexBuffers2EXT(VkCommandBuffer     commandBuffer,
                                                                    ...
                                                                    const RecordObject& record_obj)
{
    PostCallRecordCmdBindVertexBuffers2(
        commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides, record_obj);
}
...
void ValidationStateTracker::PostCallRecordCmdSetDiscardRectangleEXT(VkCommandBuffer     commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetPatchControlPointsEXT(VkCommandBuffer     commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetFragmentShadingRateKHR(
    VkCommandBuffer                          commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetRenderingInputAttachmentIndicesKHR(
    VkCommandBuffer                               commandBuffer,
    ...
    const RecordObject&                          record_obj)
{
    ...
    // "The vertex attribute description for any location not specified in the pVertexAttributeDescriptions array
    // becomes undefined"
...
void ValidationStateTracker::PostCallRecordCmdSetColorWriteEnableEXT(VkCommandBuffer     commandBuffer,
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
void ValidationStateTracker::PostCallRecordAcquireFullScreenExclusiveModeEXT(VkDevice            device,
                                                                             VkSwapchainKHR      swapchain,
                                                                             const RecordObject& record_obj)
{
    if (record_obj.result != VK_SUCCESS)
...
void ValidationStateTracker::PostCallRecordReleaseFullScreenExclusiveModeEXT(VkDevice            device,
                                                                             VkSwapchainKHR      swapchain,
                                                                             const RecordObject& record_obj)
{
    if (record_obj.result != VK_SUCCESS)
...
void ValidationStateTracker::PostCallRecordCmdSetColorBlendEnableEXT(VkCommandBuffer     commandBuffer,
...
void ValidationStateTracker::PostCallRecordCmdSetColorWriteMaskEXT(VkCommandBuffer              commandBuffer,
                                                                   uint32_t                     firstAttachment,
                                                                   uint32_t                     attachmentCount,
...
void ValidationStateTracker::PostCallRecordCmdSetViewportSwizzleNV(VkCommandBuffer            commandBuffer,
                                                                   uint32_t                   firstViewport,
                                                                   uint32_t                   viewportCount,
...
void ValidationStateTracker::PostCallRecordCmdEncodeVideoKHR(VkCommandBuffer             commandBuffer,
...
void ValidationStateTracker::PostCallRecordGetShaderModuleIdentifierEXT(VkDevice,
...
void ValidationStateTracker::PostCallRecordGetBufferDeviceAddress(VkDevice                         device,
...
void ValidationStateTracker::PostCallRecordGetBufferDeviceAddressKHR(VkDevice                         device,
                                                                     const VkBufferDeviceAddressInfo* pInfo,
                                                                     const RecordObject&              record_obj)
{
...
void ValidationStateTracker::PostCallRecordGetBufferDeviceAddressEXT(VkDevice                         device,
                                                                     const VkBufferDeviceAddressInfo* pInfo,
                                                                     const RecordObject&              record_obj)
{
    PostCallRecordGetBufferDeviceAddress(device, pInfo, record_obj);
...
std::shared_ptr<vvl::Swapchain>
ValidationStateTracker::CreateSwapchainState(const VkSwapchainCreateInfoKHR* create_info, VkSwapchainKHR handle)
{
    return std::make_shared<vvl::Swapchain>(*this, create_info, handle);
}

std::shared_ptr<vvl::CommandBuffer> ValidationStateTracker::CreateCmdBufferState(
...
ValidationStateTracker::CreateDeviceMemoryState(VkDeviceMemory                         handle,
...
{
    return std::make_shared<vvl::DeviceMemory>(handle,
                                               allocate_info,
                                               fake_address,
                                               memory_type,
                                               memory_heap,
...
void ValidationStateTracker::PostCallRecordCmdBindTransformFeedbackBuffersEXT(VkCommandBuffer     commandBuffer,
                                                                              uint32_t            firstBinding,
                                                                              uint32_t            bindingCount,
                                                                              const VkBuffer*     pBuffers,
                                                                              const VkDeviceSize* pOffsets,
...
void ValidationStateTracker::PreCallRecordLatencySleepNV(VkDevice                    device,
                                                         VkSwapchainKHR              swapchain,
...
void ValidationStateTracker::PostCallRecordLatencySleepNV(VkDevice                    device,
                                                          VkSwapchainKHR              swapchain,
                                                          const VkLatencySleepInfoNV* pSleepInfo,
                                                          const RecordObject&         record_obj)
{
...
void ValidationStateTracker::PostCallRecordCreateIndirectExecutionSetEXT(
    VkDevice                                   device,
...
void ValidationStateTracker::PostCallRecordDestroyIndirectExecutionSetEXT(
    VkDevice                     device,
...
void ValidationStateTracker::PostCallRecordCreateIndirectCommandsLayoutEXT(
    VkDevice                                     device,
...
void ValidationStateTracker::PostCallRecordDestroyIndirectCommandsLayoutEXT(
    VkDevice                     device,
