...
static const vvl::unordered_map<VkPipelineStageFlags2, std::vector<Entry>>& GetStageMaskErrorsMap() {
    static const vvl::unordered_map<VkPipelineStageFlags2, std::vector<Entry>> stage_mask_errors{
        { VK_PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT,
          std::vector<Entry>{
              { Key(Struct::VkBufferMemoryBarrier2, Field::dstStageMask),
                "VUID-VkBufferMemoryBarrier2-dstStageMask-03931" },
              { Key(Struct::VkBufferMemoryBarrier2, Field::srcStageMask),
              ...
              { Key(Func::vkCmdWriteBufferMarkerAMD, Field::stage),
              ...
              { Key(Struct::VkImageMemoryBarrier2, Field::dstStageMask),
                "VUID-VkImageMemoryBarrier2-dstStageMask-03931" },
              { Key(Struct::VkImageMemoryBarrier2, Field::srcStageMask),
        ...
        { VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR,
          std::vector<Entry>{
              ...
              { Key(Func::vkCmdWriteTimestamp, Field::rayTracingPipeline),
...
const std::vector<Entry>& GetFineSyncCommon() {
    static const std::vector<Entry> kFineSyncCommon = {
        ...
        { Key(Func::vkCmdWaitEvents, Struct::VkMemoryBarrier, Field::srcAccessMask),
          "VUID-vkCmdWaitEvents-srcAccessMask-02815" },
        { Key(Func::vkCmdWaitEvents, Struct::VkMemoryBarrier, Field::dstAccessMask),
...
const std::vector<Entry>& GetQueueCapErrors() {
    static const std::vector<Entry> kQueueCapErrors{
        ...
        { Key(Func::vkCmdWriteBufferMarkerAMD, Field::pipelineStage),
...
const vvl::unordered_map<QueueError, std::string>& GetQueueErrorSummaryMap() {
    static const vvl::unordered_map<QueueError, std::string> kQueueErrorSummary{
        ...
        { QueueError::kSync1ConcurrentSrc,
          "Source queue family must be VK_QUEUE_FAMILY_IGNORED or VK_QUEUE_FAMILY_EXTERNAL." },
        { QueueError::kSync1ConcurrentDst,
          "Destination queue family must be VK_QUEUE_FAMILY_IGNORED or VK_QUEUE_FAMILY_EXTERNAL." },
        ...
        { SubmitError::kTimelineSemMaxDiff,
          {
              ...
              { Key(Struct::VkBindSparseInfo, Field::pSignalSemaphores),
