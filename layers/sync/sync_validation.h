...
class SyncValidator : public vvl::Device, public SyncStageAccess {
  ...
  public:
    ...
    bool PropagateTimelineSignals(SignalsUpdate &signals_update, ErrorObject &error_obj) const;
    ...
    bool PreCallValidateCmdCopyImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout,
                                     ...
                                     const VkImageCopy *pRegions, ErrorObject &error_obj) const override;
    ...
    bool PreCallValidateCmdBlitImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout,
                                     VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount,
                                     const VkImageBlit *pRegions, VkFilter filter, ErrorObject &error_obj) const override;
    ...
    bool PreCallValidateCmdResolveImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout,
                                        VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount,
                                        const VkImageResolve *pRegions, ErrorObject &error_obj) const override;
