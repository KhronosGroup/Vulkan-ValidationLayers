...
const std::map<VkPipelineStageFlags2, int>& syncStageOrder() {
    ...
    { VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT, 2},
    { VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT, 3},
    { VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT, 4},
    { VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT, 5},
    { VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT, 6},
    { VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT, 7},
    { VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT, 8},
    { VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT, 9},
    { VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT, 10},
    { VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT, 11},
    { VK_PIPELINE_STAGE_2_HOST_BIT, 12},
    { VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV, 13},
    { VK_PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT, 14},
    { VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT, 15},
    { VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT, 16},
    { VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR, 17},
    { VK_PIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR, 18},
    { VK_PIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXT, 19},
    { VK_PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT, 20},
    { VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR, 21},
    { VK_PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR, 22},
    { VK_PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR, 23},
    { VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR, 24},
    { VK_PIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NV, 25},
    { VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT, 26},
    { VK_PIPELINE_STAGE_2_COPY_BIT, 27},
    { VK_PIPELINE_STAGE_2_RESOLVE_BIT, 28},
    { VK_PIPELINE_STAGE_2_BLIT_BIT, 29},
    { VK_PIPELINE_STAGE_2_CLEAR_BIT, 30},
    { VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT, 31},
    { VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT, 32},
    { VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI, 33},
