...
vvl::Extension GetExtension(std::string extension) {
    static const vvl::unordered_map<std::string, vvl::Extension> extension_map{
        ...
        {"VK_EXT_external_semaphore_drm_syncobj", vvl::Extension::_VK_EXT_external_semaphore_drm_syncobj},
    ...
    static const DeviceExtensionsInfoMap info_map = {
        ...
        {vvl::Extension::_VK_QCOM_image_processing3,
         Info(&DeviceExtensions::vk_qcom_image_processing3, {{{&DeviceExtensions::vk_khr_get_physical_device_properties2,
                                                               VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME}}})},
        {vvl::Extension::_VK_QCOM_shader_multiple_wait_queues, Info(&DeviceExtensions::vk_qcom_shader_multiple_wait_queues,
                                                                    {{{&DeviceExtensions::vk_khr_get_physical_device_properties2,
                                                                       VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME}}})},
        ...
        {vvl::Extension::_VK_EXT_external_semaphore_drm_syncobj,
         Info(&DeviceExtensions::vk_ext_external_semaphore_drm_syncobj,
              {{{&DeviceExtensions::vk_khr_timeline_semaphore, VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME}}})},
