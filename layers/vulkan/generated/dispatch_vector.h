...
typedef enum InterceptId {
    ...
    InterceptIdPreCallValidateCreateDataGraphPipelinesARM,
    InterceptIdPreCallRecordCreateDataGraphPipelinesARM,
    InterceptIdPostCallRecordCreateDataGraphPipelinesARM,
