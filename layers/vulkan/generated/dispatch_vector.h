...
typedef enum InterceptId {
    ...
    InterceptIdPreCallValidateGetSwapchainGrallocUsageOHOS,
    InterceptIdPreCallRecordGetSwapchainGrallocUsageOHOS,
    InterceptIdPostCallRecordGetSwapchainGrallocUsageOHOS,
    InterceptIdPreCallValidateAcquireImageOHOS,
    InterceptIdPreCallRecordAcquireImageOHOS,
    InterceptIdPostCallRecordAcquireImageOHOS,
    InterceptIdPreCallValidateQueueSignalReleaseImageOHOS,
    InterceptIdPreCallRecordQueueSignalReleaseImageOHOS,
    InterceptIdPostCallRecordQueueSignalReleaseImageOHOS,
