    ...
    switch (flag_bitmask) {
        case vvl::FlagBitmask::VkAccessFlagBits:
            if (value & (VK_ACCESS_NONE)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_synchronization2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_synchronization2))) {
            ...
            if (value & (VK_ACCESS_TRANSFORM_FEEDBACK_WRITE_BIT_EXT | VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_transform_feedback)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_transform_feedback))) {
                    return {vvl::Extension::_VK_EXT_transform_feedback};
                }
            }
            if (value & (VK_ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_conditional_rendering)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_conditional_rendering))) {
                    return {vvl::Extension::_VK_EXT_conditional_rendering};
                }
            }
            if (value & (VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_blend_operation_advanced)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_blend_operation_advanced))) {
            ...
            if (value & (VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR | VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_ray_tracing) &&
                     !IsExtSupported(extensions.vk_khr_acceleration_structure)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_ray_tracing) &&
                     !IsExtEnabled(extensions.vk_khr_acceleration_structure))) {
            ...
            if (value & (VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_fragment_density_map)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_fragment_density_map))) {
                    return {vvl::Extension::_VK_EXT_fragment_density_map};
                }
            }
            if (value & (VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_fragment_shading_rate) &&
                     !IsExtSupported(extensions.vk_nv_shading_rate_image)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_fragment_shading_rate) &&
                     !IsExtEnabled(extensions.vk_nv_shading_rate_image))) {
            ...
            if (value & (VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_EXT | VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_device_generated_commands) &&
                     !IsExtSupported(extensions.vk_ext_device_generated_commands)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_device_generated_commands) &&
        ...
        case vvl::FlagBitmask::VkImageAspectFlagBits:
            if (value & (VK_IMAGE_ASPECT_PLANE_0_BIT | VK_IMAGE_ASPECT_PLANE_1_BIT | VK_IMAGE_ASPECT_PLANE_2_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_sampler_ycbcr_conversion)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_sampler_ycbcr_conversion))) {
                    return {vvl::Extension::_VK_KHR_sampler_ycbcr_conversion};
                }
            }
            if (value & (VK_IMAGE_ASPECT_NONE)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance4)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance4))) {
            ...
            if (value & (VK_IMAGE_ASPECT_MEMORY_PLANE_0_BIT_EXT | VK_IMAGE_ASPECT_MEMORY_PLANE_1_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_image_drm_format_modifier)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_image_drm_format_modifier))) {
        ...
        case vvl::FlagBitmask::VkFormatFeatureFlagBits:
            if (value & (VK_FORMAT_FEATURE_TRANSFER_SRC_BIT | VK_FORMAT_FEATURE_TRANSFER_DST_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance1)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance1))) {
            ...
            if (value & (VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_sampler_filter_minmax)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_sampler_filter_minmax))) {
            ...
            if (value & (VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR | VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_decode_queue)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_decode_queue))) {
                    return {vvl::Extension::_VK_KHR_video_decode_queue};
                }
            }
            if (value & (VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_acceleration_structure)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_acceleration_structure))) {
                    return {vvl::Extension::_VK_KHR_acceleration_structure};
                }
            }
            if (value & (VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_img_filter_cubic) &&
                     !IsExtSupported(extensions.vk_ext_filter_cubic)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_img_filter_cubic) &&
                     !IsExtEnabled(extensions.vk_ext_filter_cubic))) {
            ...
            if (value & (VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR | VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_encode_queue)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_encode_queue))) {
        ...
        case vvl::FlagBitmask::VkImageCreateFlagBits:
            if (value & (VK_IMAGE_CREATE_ALIAS_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_bind_memory2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_bind_memory2))) {
                    return {vvl::Extension::_VK_KHR_bind_memory2};
                }
            }
            if (value & (VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_device_group)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_device_group))) {
            ...
            if (value & (VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT | VK_IMAGE_CREATE_EXTENDED_USAGE_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance2))) {
            ...
            if (value & (VK_IMAGE_CREATE_CORNER_SAMPLED_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_corner_sampled_image)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_corner_sampled_image))) {
                    return {vvl::Extension::_VK_NV_corner_sampled_image};
                }
            }
            if (value & (VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_descriptor_heap) &&
                     !IsExtSupported(extensions.vk_ext_descriptor_buffer)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_descriptor_heap) &&
                     !IsExtEnabled(extensions.vk_ext_descriptor_buffer))) {
                    return {vvl::Extension::_VK_EXT_descriptor_heap, vvl::Extension::_VK_EXT_descriptor_buffer};
                }
            }
            if (value & (VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_sample_locations)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_sample_locations))) {
            ...
            if (value & (VK_IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_multisampled_render_to_single_sampled)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_multisampled_render_to_single_sampled))) {
                    return {vvl::Extension::_VK_EXT_multisampled_render_to_single_sampled};
                }
            }
            if (value & (VK_IMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_image_2d_view_of_3d)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_image_2d_view_of_3d))) {
                    return {vvl::Extension::_VK_EXT_image_2d_view_of_3d};
                }
            }
            if (value & (VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_maintenance1)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_maintenance1))) {
                    return {vvl::Extension::_VK_KHR_video_maintenance1};
                }
            }
            if (value & (VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_qcom_fragment_density_map_offset) &&
                     !IsExtSupported(extensions.vk_ext_fragment_density_map_offset)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_qcom_fragment_density_map_offset) &&
        ...
        case vvl::FlagBitmask::VkImageUsageFlagBits:
            if (value & (VK_IMAGE_USAGE_HOST_TRANSFER_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_host_image_copy)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_host_image_copy))) {
            ...
            if (value & (VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_attachment_feedback_loop_layout)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_attachment_feedback_loop_layout))) {
                    return {vvl::Extension::_VK_EXT_attachment_feedback_loop_layout};
                }
            }
            if (value & (VK_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI)) {
                if ((instance_function && !IsExtSupported(extensions.vk_huawei_invocation_mask)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_huawei_invocation_mask))) {
            ...
            if (value & (VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM | VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM)) {
                if ((instance_function && !IsExtSupported(extensions.vk_qcom_image_processing)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_qcom_image_processing))) {
                    return {vvl::Extension::_VK_QCOM_image_processing};
                }
            }
            if (value & (VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM)) {
                if ((instance_function && !IsExtSupported(extensions.vk_arm_tensors)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_arm_tensors))) {
                    return {vvl::Extension::_VK_ARM_tensors};
                }
            }
            if (value & (VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM)) {
                if ((instance_function && !IsExtSupported(extensions.vk_qcom_tile_memory_heap)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_qcom_tile_memory_heap))) {
        ...
        case vvl::FlagBitmask::VkDeviceQueueCreateFlagBits:
            if (value & (VK_DEVICE_QUEUE_CREATE_INTERNALLY_SYNCHRONIZED_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_internally_synchronized_queues)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_internally_synchronized_queues))) {
                    return {vvl::Extension::_VK_KHR_internally_synchronized_queues};
                }
            }
            return {};
        case vvl::FlagBitmask::VkPipelineStageFlagBits:
            ...
            if (value & (VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_ray_tracing) &&
                     !IsExtSupported(extensions.vk_khr_ray_tracing_pipeline)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_ray_tracing) &&
                     !IsExtEnabled(extensions.vk_khr_ray_tracing_pipeline))) {
            ...
            if (value & (VK_PIPELINE_STAGE_TASK_SHADER_BIT_EXT | VK_PIPELINE_STAGE_MESH_SHADER_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_mesh_shader) &&
                     !IsExtSupported(extensions.vk_ext_mesh_shader)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_mesh_shader) &&
                     !IsExtEnabled(extensions.vk_ext_mesh_shader))) {
        ...
        case vvl::FlagBitmask::VkMemoryMapFlagBits:
            if (value & (VK_MEMORY_MAP_PLACED_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_map_memory_placed)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_map_memory_placed))) {
                    return {vvl::Extension::_VK_EXT_map_memory_placed};
                }
            }
            return {};
        case vvl::FlagBitmask::VkQueryPoolCreateFlagBits:
            if (value & (VK_QUERY_POOL_CREATE_RESET_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance9)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance9))) {
                    return {vvl::Extension::_VK_KHR_maintenance9};
                }
            }
            return {};
        case vvl::FlagBitmask::VkQueryPipelineStatisticFlagBits:
            if (value & (VK_QUERY_PIPELINE_STATISTIC_TASK_SHADER_INVOCATIONS_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_mesh_shader)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_mesh_shader))) {
            ...
            if (value & (VK_QUERY_PIPELINE_STATISTIC_CLUSTER_CULLING_SHADER_INVOCATIONS_BIT_HUAWEI)) {
                if ((instance_function && !IsExtSupported(extensions.vk_huawei_cluster_culling_shader)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_huawei_cluster_culling_shader))) {
        ...
        case vvl::FlagBitmask::VkQueryResultFlagBits:
            if (value & (VK_QUERY_RESULT_WITH_STATUS_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_queue)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_queue))) {
        ...
        case vvl::FlagBitmask::VkBufferCreateFlagBits:
            if (value & (VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_buffer_device_address) &&
                     !IsExtSupported(extensions.vk_ext_buffer_device_address)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_buffer_device_address) &&
        ...
        case vvl::FlagBitmask::VkBufferUsageFlagBits:
            ...
            if (value & (VK_BUFFER_USAGE_EXECUTION_GRAPH_SCRATCH_BIT_AMDX)) {
                if ((instance_function && !IsExtSupported(extensions.vk_amdx_shader_enqueue)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_amdx_shader_enqueue))) {
                    return {vvl::Extension::_VK_AMDX_shader_enqueue};
                }
            }
            if (value & (VK_BUFFER_USAGE_DESCRIPTOR_HEAP_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_descriptor_heap)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_descriptor_heap))) {
        ...
        case vvl::FlagBitmask::VkImageViewCreateFlagBits:
            ...
            if (value & (VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_fragment_density_map2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_fragment_density_map2))) {
        ...
        case vvl::FlagBitmask::VkDependencyFlagBits:
            ...
            if (value & (VK_DEPENDENCY_VIEW_LOCAL_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_multiview)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_multiview))) {
            ...
            if (value & (VK_DEPENDENCY_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance8)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance8))) {
        ...
        case vvl::FlagBitmask::VkPipelineCacheCreateFlagBits:
            if (value & (VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_pipeline_creation_cache_control)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_pipeline_creation_cache_control))) {
        ...
        case vvl::FlagBitmask::VkPipelineCreateFlagBits:
            if (value & (VK_PIPELINE_CREATE_DISPATCH_BASE_BIT | VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_device_group)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_device_group))) {
                    return {vvl::Extension::_VK_KHR_device_group};
                }
            ...
            if (value & (VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT | VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_pipeline_protected_access)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_pipeline_protected_access))) {
            ...
            if (value & (VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_khr_ray_tracing_pipeline)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_ray_tracing_pipeline))) {
            ...
            if (value &
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_khr_pipeline_executable_properties)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_pipeline_executable_properties))) {
            ...
            if (value & (VK_PIPELINE_CREATE_LIBRARY_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_pipeline_library)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_pipeline_library))) {
        ...
        case vvl::FlagBitmask::VkPipelineShaderStageCreateFlagBits:
            if (value & (VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_subgroup_size_control)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_subgroup_size_control))) {
        ...
        case vvl::FlagBitmask::VkShaderStageFlagBits:
            ...
            if (value & (VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI)) {
                if ((instance_function && !IsExtSupported(extensions.vk_huawei_subpass_shading)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_huawei_subpass_shading))) {
        ...
        case vvl::FlagBitmask::VkSamplerCreateFlagBits:
            ...
            if (value & (VK_SAMPLER_CREATE_NON_SEAMLESS_CUBE_MAP_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_non_seamless_cube_map)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_non_seamless_cube_map))) {
        ...
        case vvl::FlagBitmask::VkDescriptorPoolCreateFlagBits:
            if (value & (VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_descriptor_indexing)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_descriptor_indexing))) {
                    return {vvl::Extension::_VK_EXT_descriptor_indexing};
                }
            }
            if (value & (VK_DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_valve_mutable_descriptor_type) &&
                     !IsExtSupported(extensions.vk_ext_mutable_descriptor_type)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_valve_mutable_descriptor_type) &&
            ...
            if (value & (VK_DESCRIPTOR_POOL_CREATE_ALLOW_OVERALLOCATION_SETS_BIT_NV |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_nv_descriptor_pool_overallocation)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_descriptor_pool_overallocation))) {
        ...
        case vvl::FlagBitmask::VkDescriptorSetLayoutCreateFlagBits:
            ...
            if (value & (VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_push_descriptor)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_push_descriptor))) {
            ...
            if (value & (VK_DESCRIPTOR_SET_LAYOUT_CREATE_INDIRECT_BINDABLE_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_device_generated_commands_compute)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_device_generated_commands_compute))) {
            ...
            if (value & (VK_DESCRIPTOR_SET_LAYOUT_CREATE_PER_STAGE_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_per_stage_descriptor_set)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_per_stage_descriptor_set))) {
        ...
        case vvl::FlagBitmask::VkPipelineDepthStencilStateCreateFlagBits:
            if (value & (VK_PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_arm_rasterization_order_attachment_access) &&
                     !IsExtSupported(extensions.vk_ext_rasterization_order_attachment_access)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_arm_rasterization_order_attachment_access) &&
        ...
        case vvl::FlagBitmask::VkAttachmentDescriptionFlagBits:
            if (value & (VK_ATTACHMENT_DESCRIPTION_RESOLVE_SKIP_TRANSFER_FUNCTION_BIT_KHR |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance10)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance10))) {
                    return {vvl::Extension::_VK_KHR_maintenance10};
                }
            }
            return {};
        case vvl::FlagBitmask::VkFramebufferCreateFlagBits:
            if (value & (VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_imageless_framebuffer)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_imageless_framebuffer))) {
        ...
        case vvl::FlagBitmask::VkRenderPassCreateFlagBits:
            if (value & (VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM)) {
                if ((instance_function && !IsExtSupported(extensions.vk_qcom_render_pass_transform)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_qcom_render_pass_transform))) {
        ...
        case vvl::FlagBitmask::VkSubpassDescriptionFlagBits:
            if (value &
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_nvx_multiview_per_view_attributes)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nvx_multiview_per_view_attributes))) {
        ...
        case vvl::FlagBitmask::VkMemoryAllocateFlagBits:
            ...
            if (value & (VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_zero_initialize_device_memory)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_zero_initialize_device_memory))) {
        ...
        case vvl::FlagBitmask::VkExternalMemoryHandleTypeFlagBits:
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_external_memory_dma_buf)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_external_memory_dma_buf))) {
            ...
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_BIT_ANDROID)) {
                if ((instance_function && !IsExtSupported(extensions.vk_android_external_memory_android_hardware_buffer)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_android_external_memory_android_hardware_buffer))) {
            ...
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_external_memory_host)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_external_memory_host))) {
                    return {vvl::Extension::_VK_EXT_external_memory_host};
                }
            }
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA)) {
                if ((instance_function && !IsExtSupported(extensions.vk_fuchsia_external_memory)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_fuchsia_external_memory))) {
                    return {vvl::Extension::_VK_FUCHSIA_external_memory};
                }
            }
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_RDMA_ADDRESS_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_external_memory_rdma)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_external_memory_rdma))) {
            ...
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLBUFFER_BIT_EXT | VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLTEXTURE_BIT_EXT |
                ...
                if ((instance_function && !IsExtSupported(extensions.vk_ext_external_memory_metal)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_external_memory_metal))) {
        ...
        case vvl::FlagBitmask::VkExternalSemaphoreHandleTypeFlagBits:
            if (value & (VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_ZIRCON_EVENT_BIT_FUCHSIA)) {
                if ((instance_function && !IsExtSupported(extensions.vk_fuchsia_external_semaphore)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_fuchsia_external_semaphore))) {
        ...
        case vvl::FlagBitmask::VkResolveModeFlagBits:
            if (value & (VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID)) {
                if ((instance_function && !IsExtSupported(extensions.vk_android_external_format_resolve)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_android_external_format_resolve))) {
        ...
        case vvl::FlagBitmask::VkRenderingFlagBits:
            ...
            if (value & (VK_RENDERING_CONTENTS_INLINE_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_maintenance7) &&
                     !IsExtSupported(extensions.vk_ext_nested_command_buffer)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_maintenance7) &&
                     !IsExtEnabled(extensions.vk_ext_nested_command_buffer))) {
        ...
        case vvl::FlagBitmask::VkSwapchainCreateFlagBitsKHR:
            ...
            if (value & (VK_SWAPCHAIN_CREATE_MUTABLE_FORMAT_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_swapchain_mutable_format)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_swapchain_mutable_format))) {
                    return {vvl::Extension::_VK_KHR_swapchain_mutable_format};
                }
            }
            if (value & (VK_SWAPCHAIN_CREATE_PRESENT_TIMING_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_present_timing)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_present_timing))) {
                    return {vvl::Extension::_VK_EXT_present_timing};
                }
            }
            if (value & (VK_SWAPCHAIN_CREATE_PRESENT_ID_2_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_present_id2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_present_id2))) {
                    return {vvl::Extension::_VK_KHR_present_id2};
                }
            }
            if (value & (VK_SWAPCHAIN_CREATE_PRESENT_WAIT_2_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_present_wait2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_present_wait2))) {
                    return {vvl::Extension::_VK_KHR_present_wait2};
                }
            }
            if (value & (VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_swapchain_maintenance1) &&
                     !IsExtSupported(extensions.vk_ext_swapchain_maintenance1)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_swapchain_maintenance1) &&
        ...
        case vvl::FlagBitmask::VkVideoSessionCreateFlagBitsKHR:
            ...
            if (value & (VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_maintenance2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_maintenance2))) {
        ...
        case vvl::FlagBitmask::VkVideoEncodeFlagBitsKHR:
            if (value & (VK_VIDEO_ENCODE_INTRA_REFRESH_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_video_encode_intra_refresh)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_video_encode_intra_refresh))) {
                    return {vvl::Extension::_VK_KHR_video_encode_intra_refresh};
                }
            }
        ...
        case vvl::FlagBitmask::VkDebugUtilsMessageTypeFlagBitsEXT:
            if (value & (VK_DEBUG_UTILS_MESSAGE_TYPE_DEVICE_ADDRESS_BINDING_BIT_EXT)) {
                if ((instance_function && !IsExtSupported(extensions.vk_ext_device_address_binding_report)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_ext_device_address_binding_report))) {
        ...
        case vvl::FlagBitmask::VkBuildAccelerationStructureFlagBitsKHR:
            ...
            if (value & (VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DATA_ACCESS_BIT_KHR)) {
                if ((instance_function && !IsExtSupported(extensions.vk_khr_ray_tracing_position_fetch)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_khr_ray_tracing_position_fetch))) {
            ...
            if (value & (VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_CLUSTER_OPACITY_MICROMAPS_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_cluster_acceleration_structure)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_cluster_acceleration_structure))) {
...
vvl::Extensions stateless::Context::IsValidFlag64Value(vvl::FlagBitmask flag_bitmask, VkFlags64 value,
                                                       bool instance_function) const {
    switch (flag_bitmask) {
        case vvl::FlagBitmask::VkPipelineStageFlagBits2:
            ...
            if (value & (VK_PIPELINE_STAGE_2_MEMORY_DECOMPRESSION_BIT_EXT)) {
                if (!IsExtEnabled(extensions.vk_ext_memory_decompression)) {
                    return {vvl::Extension::_VK_EXT_memory_decompression};
                }
            }
            return {};
        case vvl::FlagBitmask::VkAccessFlagBits2:
            ...
            if (value & (VK_ACCESS_2_SAMPLER_HEAP_READ_BIT_EXT | VK_ACCESS_2_RESOURCE_HEAP_READ_BIT_EXT)) {
            ...
            if (value & (VK_ACCESS_2_MEMORY_DECOMPRESSION_READ_BIT_EXT | VK_ACCESS_2_MEMORY_DECOMPRESSION_WRITE_BIT_EXT)) {
                if (!IsExtEnabled(extensions.vk_ext_memory_decompression)) {
                    return {vvl::Extension::_VK_EXT_memory_decompression};
                }
            }
        ...
        case vvl::FlagBitmask::VkBufferUsageFlagBits2:
            ...
            if (value & (VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT)) {
                if (!IsExtEnabled(extensions.vk_ext_descriptor_heap)) {
                    return {vvl::Extension::_VK_EXT_descriptor_heap};
                }
            }
        ...
        case vvl::FlagBitmask::VkPipelineCreateFlagBits2:
            ...
            if (value & (VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT)) {
                if (!IsExtEnabled(extensions.vk_ext_descriptor_heap)) {
                    return {vvl::Extension::_VK_EXT_descriptor_heap};
                }
            }
            ...
            if (value & (VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT)) {
                if (!IsExtEnabled(extensions.vk_ext_shader_64bit_indexing)) {
                    return {vvl::Extension::_VK_EXT_shader_64bit_indexing};
                }
            }
            return {};
...
std::string stateless::Context::DescribeFlagBitmaskValue(vvl::FlagBitmask flag_bitmask, VkFlags value) const {
    switch (flag_bitmask) {
        ...
        case vvl::FlagBitmask::VkQueryPoolCreateFlagBits:
            return string_VkQueryPoolCreateFlags(value);
        case vvl::FlagBitmask::VkQueryPipelineStatisticFlagBits:
        ...
        case vvl::FlagBitmask::VkResolveImageFlagBitsKHR:
            return string_VkResolveImageFlagsKHR(value);
...
std::string stateless::Context::DescribeFlagBitmaskValue64(vvl::FlagBitmask flag_bitmask, VkFlags64 value) const {
    switch (flag_bitmask) {
        ...
        case vvl::FlagBitmask::VkMemoryDecompressionMethodFlagBitsEXT:
            return string_VkMemoryDecompressionMethodFlagsEXT(value);
        case vvl::FlagBitmask::VkTensorCreateFlagBitsARM:
            return string_VkTensorCreateFlagsARM(value);
        case vvl::FlagBitmask::VkTensorUsageFlagBitsARM:
