...
const OperandInfo& GetOperandInfo(uint32_t opcode) {
    static const vvl::unordered_map<uint32_t, OperandInfo> kOperandTable{
        ...
        {spv::OpLoopMerge, {{OperandKind::Id, OperandKind::Id, OperandKind::BitEnum}}},
        {spv::OpSelectionMerge, {{OperandKind::Id, OperandKind::BitEnum}}},
        {spv::OpLabel, {{}}},
        {spv::OpBranch, {{OperandKind::Id}}},
        {spv::OpBranchConditional, {{OperandKind::Id, OperandKind::Id, OperandKind::Id, OperandKind::Literal}}},
        {spv::OpSwitch, {{OperandKind::Id, OperandKind::Id, OperandKind::Composite}}},
        {spv::OpKill, {{}}},
        {spv::OpReturn, {{}}},
