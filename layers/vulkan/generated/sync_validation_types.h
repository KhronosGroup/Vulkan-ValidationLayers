...
enum SyncStageAccessIndex {
    ...
    SYNC_TESSELLATION_CONTROL_SHADER_ACCELERATION_STRUCTURE_READ = 9,
    SYNC_TESSELLATION_CONTROL_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 10,
    ...
    SYNC_TESSELLATION_EVALUATION_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 16,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_SAMPLED_READ = 17,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_READ = 18,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_WRITE = 19,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 20,
    SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ = 21,
    SYNC_GEOMETRY_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 22,
    SYNC_GEOMETRY_SHADER_SHADER_SAMPLED_READ = 23,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_READ = 24,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_WRITE = 25,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 26,
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ = 27,
    SYNC_FRAGMENT_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 28,
    ...
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 36,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 37,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 38,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 39,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 40,
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ = 41,
    SYNC_COMPUTE_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 42,
    SYNC_COMPUTE_SHADER_SHADER_SAMPLED_READ = 43,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_READ = 44,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_WRITE = 45,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 46,
    SYNC_HOST_HOST_READ = 47,
    SYNC_HOST_HOST_WRITE = 48,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 49,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 50,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 51,
    SYNC_TASK_SHADER_EXT_ACCELERATION_STRUCTURE_READ = 52,
    SYNC_TASK_SHADER_EXT_DESCRIPTOR_BUFFER_READ_EXT = 53,
    SYNC_TASK_SHADER_EXT_SHADER_SAMPLED_READ = 54,
    SYNC_TASK_SHADER_EXT_SHADER_STORAGE_READ = 55,
    SYNC_TASK_SHADER_EXT_SHADER_STORAGE_WRITE = 56,
    SYNC_TASK_SHADER_EXT_UNIFORM_READ = 57,
    SYNC_MESH_SHADER_EXT_ACCELERATION_STRUCTURE_READ = 58,
    SYNC_MESH_SHADER_EXT_DESCRIPTOR_BUFFER_READ_EXT = 59,
    SYNC_MESH_SHADER_EXT_SHADER_SAMPLED_READ = 60,
    SYNC_MESH_SHADER_EXT_SHADER_STORAGE_READ = 61,
    SYNC_MESH_SHADER_EXT_SHADER_STORAGE_WRITE = 62,
    SYNC_MESH_SHADER_EXT_UNIFORM_READ = 63,
    SYNC_RAY_TRACING_SHADER_ACCELERATION_STRUCTURE_READ = 64,
    SYNC_RAY_TRACING_SHADER_DESCRIPTOR_BUFFER_READ_EXT = 65,
    SYNC_RAY_TRACING_SHADER_SHADER_BINDING_TABLE_READ = 66,
    SYNC_RAY_TRACING_SHADER_SHADER_SAMPLED_READ = 67,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_READ = 68,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_WRITE = 69,
    SYNC_RAY_TRACING_SHADER_UNIFORM_READ = 70,
    SYNC_FRAGMENT_SHADING_RATE_ATTACHMENT_FRAGMENT_SHADING_RATE_ATTACHMENT_READ = 71,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 72,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 73,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 74,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 75,
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_MICROMAP_READ_EXT = 79,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_SAMPLED_READ = 80,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 81,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ = 82,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_WRITE = 83,
    SYNC_ACCELERATION_STRUCTURE_BUILD_UNIFORM_READ = 84,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_READ = 85,
    SYNC_VIDEO_DECODE_VIDEO_DECODE_WRITE = 86,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_READ = 87,
    SYNC_VIDEO_ENCODE_VIDEO_ENCODE_WRITE = 88,
    SYNC_ACCELERATION_STRUCTURE_COPY_ACCELERATION_STRUCTURE_READ = 89,
    SYNC_ACCELERATION_STRUCTURE_COPY_ACCELERATION_STRUCTURE_WRITE = 90,
    SYNC_ACCELERATION_STRUCTURE_COPY_TRANSFER_READ = 91,
    SYNC_ACCELERATION_STRUCTURE_COPY_TRANSFER_WRITE = 92,
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_READ_NV = 93,
    SYNC_OPTICAL_FLOW_NV_OPTICAL_FLOW_WRITE_NV = 94,
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_READ_EXT = 95,
    SYNC_MICROMAP_BUILD_EXT_MICROMAP_WRITE_EXT = 96,
    SYNC_COPY_TRANSFER_READ = 97,
    SYNC_COPY_TRANSFER_WRITE = 98,
    SYNC_RESOLVE_TRANSFER_READ = 99,
    SYNC_RESOLVE_TRANSFER_WRITE = 100,
    SYNC_BLIT_TRANSFER_READ = 101,
    SYNC_BLIT_TRANSFER_WRITE = 102,
    SYNC_CLEAR_TRANSFER_WRITE = 103,
