...
enum SyncAccessIndex {
    ...
    SYNC_COMMAND_PREPROCESS_EXT_COMMAND_PREPROCESS_READ_EXT = 57,
    SYNC_COMMAND_PREPROCESS_EXT_COMMAND_PREPROCESS_WRITE_EXT = 58,
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_READ = 90,
    ...
    SYNC_MICROMAP_BUILD_EXT_SHADER_READ = 105,
