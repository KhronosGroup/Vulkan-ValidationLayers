...
static const VkAccessFlagBits2 VK_ACCESS_2_PRESENT_ACQUIRE_READ_BIT_SYNCVAL = 0x0200000000000000ULL;
static const VkAccessFlagBits2 VK_ACCESS_2_PRESENT_PRESENTED_BIT_SYNCVAL = 0x0400000000000000ULL;
...
enum SyncAccessIndex {
    ...
    SYNC_DATA_GRAPH_ARM_DATA_GRAPH_READ_ARM = 137,
    SYNC_DATA_GRAPH_ARM_DATA_GRAPH_WRITE_ARM = 138,
    SYNC_CONVERT_COOPERATIVE_VECTOR_MATRIX_NV_TRANSFER_READ = 139,
    SYNC_CONVERT_COOPERATIVE_VECTOR_MATRIX_NV_TRANSFER_WRITE = 140,
    SYNC_MEMORY_DECOMPRESSION_EXT_MEMORY_DECOMPRESSION_READ_EXT = 141,
    SYNC_MEMORY_DECOMPRESSION_EXT_MEMORY_DECOMPRESSION_WRITE_EXT = 142,
    SYNC_COPY_INDIRECT_INDIRECT_COMMAND_READ = 143,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 144,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 145,
    SYNC_IMAGE_LAYOUT_TRANSITION = 146,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 147,
};
...
const std::array<SyncAccessInfo, 148>& GetSyncAccessInfos();
