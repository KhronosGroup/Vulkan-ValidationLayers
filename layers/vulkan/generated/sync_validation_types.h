...
enum SyncAccessIndex {
    ...
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 141,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 142,
    SYNC_IMAGE_LAYOUT_TRANSITION = 143,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 144,
};
...
const std::array<SyncAccessInfo, 145>& GetSyncAccessInfos();
