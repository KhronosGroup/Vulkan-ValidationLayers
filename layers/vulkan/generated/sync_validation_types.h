...
enum SyncAccessIndex {
    ...
    SYNC_COPY_INDIRECT_INDIRECT_COMMAND_READ = 141,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 142,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 143,
    SYNC_IMAGE_LAYOUT_TRANSITION = 144,
...
const std::array<SyncAccessInfo, 146>& GetSyncAccessInfos();
