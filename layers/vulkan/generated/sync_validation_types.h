...
enum SyncStageAccessIndex {
    ...
    SYNC_SUBPASS_SHADER_HUAWEI_ACCELERATION_STRUCTURE_READ = 115,
    SYNC_SUBPASS_SHADER_HUAWEI_DESCRIPTOR_BUFFER_READ_EXT = 116,
    SYNC_SUBPASS_SHADER_HUAWEI_INPUT_ATTACHMENT_READ = 117,
    SYNC_SUBPASS_SHADER_HUAWEI_SHADER_BINDING_TABLE_READ = 118,
    SYNC_SUBPASS_SHADER_HUAWEI_SHADER_SAMPLED_READ = 119,
    SYNC_SUBPASS_SHADER_HUAWEI_SHADER_STORAGE_READ = 120,
    SYNC_SUBPASS_SHADER_HUAWEI_SHADER_STORAGE_WRITE = 121,
    SYNC_SUBPASS_SHADER_HUAWEI_UNIFORM_READ = 122,
    SYNC_INVOCATION_MASK_HUAWEI_INVOCATION_MASK_READ_HUAWEI = 123,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_ACCELERATION_STRUCTURE_READ = 124,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_DESCRIPTOR_BUFFER_READ_EXT = 125,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_BINDING_TABLE_READ = 126,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_SAMPLED_READ = 127,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_STORAGE_READ = 128,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_SHADER_STORAGE_WRITE = 129,
    SYNC_CLUSTER_CULLING_SHADER_HUAWEI_UNIFORM_READ = 130,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 131,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 132,
    SYNC_IMAGE_LAYOUT_TRANSITION = 133,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 134,
};
