...
typedef enum CBDynamicState {
    ...
    CB_DYNAMIC_STATE_VERTEX_INPUT_EXT = 36,
    CB_DYNAMIC_STATE_PATCH_CONTROL_POINTS_EXT = 37,
    CB_DYNAMIC_STATE_LOGIC_OP_EXT = 38,
    CB_DYNAMIC_STATE_COLOR_WRITE_ENABLE_EXT = 39,
    CB_DYNAMIC_STATE_DEPTH_CLAMP_ENABLE_EXT = 40,
    CB_DYNAMIC_STATE_POLYGON_MODE_EXT = 41,
    CB_DYNAMIC_STATE_RASTERIZATION_SAMPLES_EXT = 42,
    CB_DYNAMIC_STATE_SAMPLE_MASK_EXT = 43,
    CB_DYNAMIC_STATE_ALPHA_TO_COVERAGE_ENABLE_EXT = 44,
    CB_DYNAMIC_STATE_ALPHA_TO_ONE_ENABLE_EXT = 45,
    CB_DYNAMIC_STATE_LOGIC_OP_ENABLE_EXT = 46,
    CB_DYNAMIC_STATE_COLOR_BLEND_ENABLE_EXT = 47,
    CB_DYNAMIC_STATE_COLOR_BLEND_EQUATION_EXT = 48,
    CB_DYNAMIC_STATE_COLOR_WRITE_MASK_EXT = 49,
    CB_DYNAMIC_STATE_TESSELLATION_DOMAIN_ORIGIN_EXT = 50,
    CB_DYNAMIC_STATE_RASTERIZATION_STREAM_EXT = 51,
    CB_DYNAMIC_STATE_CONSERVATIVE_RASTERIZATION_MODE_EXT = 52,
    CB_DYNAMIC_STATE_EXTRA_PRIMITIVE_OVERESTIMATION_SIZE_EXT = 53,
    CB_DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT = 54,
    CB_DYNAMIC_STATE_SAMPLE_LOCATIONS_ENABLE_EXT = 55,
    CB_DYNAMIC_STATE_COLOR_BLEND_ADVANCED_EXT = 56,
    CB_DYNAMIC_STATE_PROVOKING_VERTEX_MODE_EXT = 57,
    CB_DYNAMIC_STATE_LINE_RASTERIZATION_MODE_EXT = 58,
    CB_DYNAMIC_STATE_LINE_STIPPLE_ENABLE_EXT = 59,
    CB_DYNAMIC_STATE_DEPTH_CLIP_NEGATIVE_ONE_TO_ONE_EXT = 60,
    CB_DYNAMIC_STATE_VIEWPORT_W_SCALING_ENABLE_NV = 61,
    CB_DYNAMIC_STATE_VIEWPORT_SWIZZLE_NV = 62,
    CB_DYNAMIC_STATE_COVERAGE_TO_COLOR_ENABLE_NV = 63,
    CB_DYNAMIC_STATE_COVERAGE_TO_COLOR_LOCATION_NV = 64,
    CB_DYNAMIC_STATE_COVERAGE_MODULATION_MODE_NV = 65,
    CB_DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_ENABLE_NV = 66,
    CB_DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_NV = 67,
    CB_DYNAMIC_STATE_SHADING_RATE_IMAGE_ENABLE_NV = 68,
    CB_DYNAMIC_STATE_REPRESENTATIVE_FRAGMENT_TEST_ENABLE_NV = 69,
    CB_DYNAMIC_STATE_COVERAGE_REDUCTION_MODE_NV = 70,
    CB_DYNAMIC_STATE_ATTACHMENT_FEEDBACK_LOOP_ENABLE_EXT = 71,
    CB_DYNAMIC_STATE_LINE_STIPPLE_KHR = 72,
