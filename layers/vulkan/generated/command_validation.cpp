...
{Func::vkCmdDebugMarkerBeginEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdDebugMarkerBeginEXT-suspended",
    false, true, false,
}},
{Func::vkCmdDebugMarkerEndEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdDebugMarkerEndEXT-suspended",
    false, true, false,
}},
{Func::vkCmdDebugMarkerInsertEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdDebugMarkerInsertEXT-suspended",
    false, true, false,
}},
...
{Func::vkCmdBeginDebugUtilsLabelEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdBeginDebugUtilsLabelEXT-suspended",
    true, true, false,
}},
{Func::vkCmdEndDebugUtilsLabelEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdEndDebugUtilsLabelEXT-suspended",
    true, true, false,
}},
{Func::vkCmdInsertDebugUtilsLabelEXT, {
    ...
    CommandScope::Both, kVUIDUndefined,
    CommandScope::Both, kVUIDUndefined,
    "VUID-vkCmdInsertDebugUtilsLabelEXT-suspended",
    false, true, false,
}},
