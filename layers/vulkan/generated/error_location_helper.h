...
enum class Extension {
    ...
    _VK_EXT_cooperative_matrix_maintenance1,
    ...
    _VK_KHR_pipeline_library_group_handles,
    ...
    _VK_NV_private_data_base_handle,
    ...
    _VK_SEC_ubm_surface,
    _VK_VALVE_buffer_device_address_allocation_alignment,
