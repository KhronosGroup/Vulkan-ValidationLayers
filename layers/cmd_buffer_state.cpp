...
void CMD_BUFFER_STATE::Reset() {
    ...
    dynamic_color_write_enable_attachment_count = 0;
...
void CMD_BUFFER_STATE::RecordColorWriteEnableStateCmd(CMD_TYPE cmd_type, CBStatusFlags state_bits, uint32_t attachment_count) {
    ...
    dynamic_color_write_enable_attachment_count = std::max(dynamic_color_write_enable_attachment_count, attachment_count);
}
