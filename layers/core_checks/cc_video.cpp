...
CoreChecks::GetVideoFormatProperties(VkImageUsageFlags image_usage, const VkVideoProfileListInfoKHR* profile_list) const
{
                                             ...
                                             const Location&             loc) const
{
    ...
    if (picture_info)
    {
        ...
        for (uint32_t slice_idx = 0; slice_idx < picture_info->naluSliceEntryCount; ++slice_idx)
        {
            ...
            if (std_pps != nullptr && (profile_caps.encode_h264.flags &
                                             ...
                                             const Location&             loc) const
{
    ...
    if (picture_info)
    {
        ...
        for (uint32_t slice_seg_idx = 0; slice_seg_idx < picture_info->naluSliceSegmentEntryCount; ++slice_seg_idx)
        {
            ...
            if (std_pps != nullptr && (profile_caps.encode_h265.flags &
