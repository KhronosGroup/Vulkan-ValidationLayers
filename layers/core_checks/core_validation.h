...
bool ValidateVideoProfileInfo(const StateObject& state, const VkVideoProfileInfoKHR* profile, ErrorObject& error_obj,
                              const Location& loc);
template <typename StateObject>
bool ValidateVideoProfileListInfo(const StateObject& state, const VkVideoProfileListInfoKHR* profile_list, ErrorObject& error_obj,
                                  const Location& loc, bool expect_decode_profile, const char* missing_decode_profile_msg_code,
                                  bool expect_encode_profile, const char* missing_encode_profile_msg_code);
}  // namespace core
...
class CoreChecks : public vvl::Device {
  ...
  public:
    ...
    bool ValidateRenderPassDAG(const VkRenderPassCreateInfo2* pCreateInfo, ErrorObject& error_obj) const;
    ...
    bool ValidateSubpassDependency(ErrorObject& error_obj, const Location& loc, const VkSubpassDependency2& barrier) const;
    ...
    bool ValidateMemoryIsMapped(uint32_t mem_range_count, const VkMappedMemoryRange* mem_ranges, ErrorObject& error_obj) const;
    ...
    bool ValidateBindImageMemory(uint32_t bindInfoCount, const VkBindImageMemoryInfo* pBindInfos, ErrorObject& error_obj) const;
    ...
    bool ValidateCmdNextSubpass(VkCommandBuffer commandBuffer, ErrorObject& error_obj) const;
    ...
    bool ValidateAttachmentReference(VkAttachmentReference2 reference, const VkFormat attachment_format, bool input,
                                     const Location& loc) const;
    bool ValidateRenderpassAttachmentUsage(const VkRenderPassCreateInfo2* pCreateInfo, ErrorObject& error_obj) const;
    ...
    bool ValidateCreateRenderPass(const VkRenderPassCreateInfo2* pCreateInfo, ErrorObject& error_obj) const;
    ...
    bool ValidateDepthStencilResolve(const VkRenderPassCreateInfo2* pCreateInfo, ErrorObject& error_obj) const;
    ...
    bool PreCallValidateGetPipelineExecutableStatisticsKHR(VkDevice device, const VkPipelineExecutableInfoKHR* pExecutableInfo,
                                                           ...
                                                           ErrorObject& error_objs) const override;
    ...
    bool ValidateAccelerationStructuresDeviceScratchBufferMemoryAlisasing(
        ...
        uint32_t info_i, const VkAccelerationStructureBuildRangeInfoKHR* const* pp_range_infos, ErrorObject& error_obj) const;
    ...
    bool PreCallValidateCmdBindIndexBuffer2KHR(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset,
                                               VkDeviceSize size, VkIndexType indexType, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateCmdBeginQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t slot,
                                      VkQueryControlFlags flags, ErrorObject& error_obj) const override;
    ...
    bool MsRenderedToSingleSampledValidateFBAttachments(uint32_t count, const VkAttachmentReference2* attachments,
                                                        ...
                                                        const Location& create_info_loc) const;
    bool ValidateFragmentShadingRateAttachments(const VkRenderPassCreateInfo2* pCreateInfo, ErrorObject& error_obj) const;
    ...
    bool PreCallValidateMapMemory(VkDevice device, VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size, VkFlags flags,
                                  void** ppData, ErrorObject& error_obj) const override;
    bool PreCallValidateUnmapMemory(VkDevice device, VkDeviceMemory mememorym, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateGetImageSubresourceLayout2(VkDevice device, VkImage image, const VkImageSubresource2* pSubresource,
                                                   VkSubresourceLayout2KHR* pLayout, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateGetImageSubresourceLayout2EXT(VkDevice device, VkImage image, const VkImageSubresource2EXT* pSubresource,
                                                      VkSubresourceLayout2EXT* pLayout, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateGetDescriptorSetLayoutSizeEXT(VkDevice device, VkDescriptorSetLayout layout,
                                                      VkDeviceSize* pLayoutSizeInBytes, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateCmdBindDescriptorBufferEmbeddedSamplersEXT(VkCommandBuffer commandBuffer,
                                                                   ...
                                                                   uint32_t set, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateGetDeviceFaultInfoEXT(VkDevice device, VkDeviceFaultCountsEXT* pFaultCounts,
                                              VkDeviceFaultInfoEXT* pFaultInfo, ErrorObject& error_obj) const override;
    ...
    bool PreCallValidateCreatePipelineBinariesKHR(VkDevice device, const VkPipelineBinaryCreateInfoKHR* pCreateInfo,
                                                  const VkAllocationCallbacks* pAllocator,
                                                  VkPipelineBinaryHandlesInfoKHR* pBinaries, ErrorObject& error_obj) const override;
