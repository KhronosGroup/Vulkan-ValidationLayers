...
class CoreChecks : public vvl::DeviceProxy {
  ...
  public:
    ...
    bool ValidatePipelineIsDataGraphPipeline(const vvl::Pipeline& pipeline, const Location& loc, const char* vuid) const;
    ...
    bool PreCallValidateGetDataGraphPipelineSessionBindPointRequirementsARM(VkDevice device,
