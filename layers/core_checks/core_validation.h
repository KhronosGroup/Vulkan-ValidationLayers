...
class CoreChecks : public vvl::DeviceProxy {
  ...
  public:
    ...
    bool ValidateDrawAttachments(const LastBound& last_bound_state, const vvl::DrawDispatchVuid& vuid) const;
    ...
    bool VerifyPipeleinLayoutCompatibilityUnion(const vvl::PipelineLayout& layout, const vvl::PipelineLayout& pre_raster_layout,
    ...
    bool PreCallValidateCreateTensorARM(VkDevice device, const VkTensorCreateInfoARM* pCreateInfo,
                                        ...
                                        const ErrorObject& error_obj) const override;
    bool ValidateTensorCreateInfo(const VkTensorCreateInfoARM* pCreateInfo, const ErrorObject& error_obj) const;
