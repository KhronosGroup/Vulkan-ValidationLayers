                                               ...
                                               const Location&             allocate_info_loc) const
{
    ...
    if ((import_ahb_info) && (NULL != import_ahb_info->buffer))
    {
        ...
        if (0 ==
            (ext_buf_props.externalMemoryProperties.externalMemoryFeatures & VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT))
        {
        ...
        { // Checks specific to import with a dedicated allocation requirement
