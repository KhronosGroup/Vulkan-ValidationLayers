        ...
        {VK_ACCESS_2_MEMORY_DECOMPRESSION_READ_BIT_EXT,
         ValueType{{
             {Key(Struct::VkMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
             {Key(Struct::VkMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
             {Key(Struct::VkBufferMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkBufferMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
             {Key(Struct::VkBufferMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkBufferMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
             {Key(Struct::VkImageMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkImageMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
             {Key(Struct::VkImageMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkImageMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_READ_EXT"},
         }}},
        {VK_ACCESS_2_MEMORY_DECOMPRESSION_WRITE_BIT_EXT,
         ValueType{{
             {Key(Struct::VkMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
             {Key(Struct::VkMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
             {Key(Struct::VkBufferMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkBufferMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
             {Key(Struct::VkBufferMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkBufferMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
             {Key(Struct::VkImageMemoryBarrier2, Field::srcAccessMask),
              "VUID-VkImageMemoryBarrier2-srcAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
             {Key(Struct::VkImageMemoryBarrier2, Field::dstAccessMask),
              "VUID-VkImageMemoryBarrier2-dstAccessMask-UNASSIGNED-MEMORY_DECOMPRESSION_WRITE_EXT"},
         }}}};
