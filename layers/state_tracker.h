...
enum CopyCommandVersion { COPY_COMMAND_VERSION_1 = 0, COPY_COMMAND_VERSION_2KHR = 1, COPY_COMMAND_VERSION_2 = 2 };
...
class ValidationStateTracker : public ValidationObject {
  ...
  public:
    ...
    void RecordCmdSetViewportWithCountEXT(VkCommandBuffer commandBuffer, uint32_t viewportCount, const VkViewport* pViewports,
                                          CMD_TYPE cmdType);
