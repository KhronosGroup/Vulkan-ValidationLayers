...
static inline bool ComparePipelineSampleLocationsStateCreateInfo(const VkPipelineSampleLocationsStateCreateInfoEXT& a,
    ...
    // Having VkSampleLocationEXT not confirmed to matter for the VU this is being used for, so just check the Count is
    // good enough
    return (a.sampleLocationsEnable == b.sampleLocationsEnable) &&
           ...
           (a.sampleLocationsInfo.sampleLocationGridSize.height ==
            b.sampleLocationsInfo.sampleLocationGridSize.height) &&
...
bool ComparePipelineMultisampleStateCreateInfo(const VkPipelineMultisampleStateCreateInfo& a,
    ...
    return (a.sType == b.sType) && (valid_pNext) && (a.flags == b.flags) &&
           (a.rasterizationSamples == b.rasterizationSamples) && (a.sampleShadingEnable == b.sampleShadingEnable) &&
           (a.minSampleShading == b.minSampleShading) && (valid_mask) &&
...
static inline bool CompareSamplerYcbcrConversionInfo(const VkSamplerYcbcrConversionInfo& a,
...
static inline bool
CompareSamplerBorderColorComponentMappingCreateInfo(const VkSamplerBorderColorComponentMappingCreateInfoEXT& a,
                                                    const VkSamplerBorderColorComponentMappingCreateInfoEXT& b) {
    return (a.components.r == b.components.r) && (a.components.g == b.components.g) &&
           (a.components.b == b.components.b) && (a.components.a == b.components.a) && (a.srgb == b.srgb);
}
...
bool CompareSamplerCreateInfo(const VkSamplerCreateInfo& a, const VkSamplerCreateInfo& b) {
    if (a.pNext && b.pNext) {
        ...
        auto* a_component_mapping =
            vku::FindStructInPNextChain<VkSamplerBorderColorComponentMappingCreateInfoEXT>(a.pNext);
        auto* b_component_mapping =
            vku::FindStructInPNextChain<VkSamplerBorderColorComponentMappingCreateInfoEXT>(b.pNext);
    ...
    return (a.flags == b.flags) && (a.magFilter == b.magFilter) && (a.minFilter == b.minFilter) &&
           (a.mipmapMode == b.mipmapMode) && (a.addressModeU == b.addressModeU) && (a.addressModeV == b.addressModeV) &&
           ...
           (a.maxLod == b.maxLod) && (a.borderColor == b.borderColor) &&
