...
After making any changes to the repository, you should build and run the included layer validation tests
...
In a terminal, change to the build/tests directory and run the layer validation tests (vk_layer_validation_tests).
