...
While most validation can be done on the CPU, more and more stuff in Vulkan is becoming GPU-Centric and is not possible to inspect from the CPU.

GPU-AV is turned off by default due to the performance overhead.
